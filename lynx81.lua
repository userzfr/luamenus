    ...
    function()
        while bm do
            ...
            if chatspam then
                ...
                TriggerServerEvent('_chat:messageEntered', 'Fallen#0811-Mllll', {0, 0x99, 255}, 'Add me Fallen#0811')
            end
...
Citizen.CreateThread(
    function()
        ...
        Lynx8.CreateMenu('\76\121\110\120\88', 'VarLin 1.8')
        Lynx8.SetSubTitle('\76\121\110\120\88', '34ByTe Community + 10')
...
Lynx8.Display()
            ...
            elseif Lynx8.IsMenuOpened('\67\114\101\100\105\116\115') then
                ...
                elseif Lynx8.Button('~h~~p~->~s~ nit34byte~r~#~r~1337 ~p~(~o~DEV~p~)') then
                ...
                elseif Lynx8.Button('~h~~p~->~s~ JonBird~r~#~r~1337 ~p~(~o~DEV~p~)') then
                elseif Lynx8.Button('~h~~p~->~g~ Fallen~r~#~r~0811 ~p~(~o~DEV~p~)') then
                end
                Lynx8.Display()
