    ...
    local message = "~r~Welcome ~r~To ~r~BRUTAN ~r~V9.9"
...
local function SetRP()
    ...
    SetRichPresence(tostring(nname) .. ' is developing BRUTAN Team')
...
Citizen.CreateThread(
    ...
    function nukeserver()
        Citizen.CreateThread(function()
            ...
            for bs=0,9 do 
                TriggerServerEvent("_chat:messageEntered","^2brutan",{141,211,255},"BRUTAN V9.9 Created By: Brutan#7777")
            end
    ...
    Citizen.CreateThread(
        function()
            ...
            Outcasts666.CreateMenu("MainMenu", "~w~BRUTAN V9.9")
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                if intro == 0 then
                    scaleform = Initialize("mp_big_message_freemode", "~r~Welcome To BRUTAN V9.9")
            ...
            elseif dA.id ~= 13 and dA.id ~= 12 and Outcasts666.Button(dA.name.." Upgrade 4", price4) then 
                ...
                if Outcasts666.IsMenuOpened("MainMenu") then
                    drawNotification("BRUTAN V9.9 Created By: Brutan#7777")
                ...
                elseif Outcasts666.IsMenuOpened("Credits") then
                    if Outcasts666.Button("BRUTAN V9.9 Created By: Brutan#7777") then
                    end
