	...
	function()
		while Enabled do
			...
			if banallusers then
				...
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "MALOSSIHOSTING ON YOUTUBE BEST FIVEM CHEATS", 300)
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "MALOSSIHOSTING ON YOUTUBE BEST FIVEM CHEATS/")
				TriggerServerEvent("esx-qalle-jail:jailPlayerNew", GetPlayerServerId(i), 5000, "MALOSSIHOSTING ON YOUTUBE BEST FIVEM CHEATS/")
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 50000)
				TriggerServerEvent("8321hiue89js", GetPlayerServerId(i), 5007, "MALOSSIHOSTING ON YOUTUBE BEST FIVEM CHEATS/", 32532532, securityToken)
				TriggerServerEvent("esx_jailer:sendToJailCatfrajerze", GetPlayerServerId(i), 300000, "MALOSSIHOSTING ON YOUTUBE BEST FIVEM CHEATS/", 500324532)
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "MALOSSIHOSTING ON YOUTUBE BEST FIVEM CHEATS/")
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 5000, "dude weed")
				TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .." MALOSSIHOSTING ON YOUTUBE BEST FIVEM CHEATS/.")
					end
				end
                    ...
                    function()
                        ...
                        for bD = 5, 5 do
                            TriggerServerEvent(
                                ...
                                '^' .. bD .. 'LUA MENU V2.0 ~ https://discord.gg/qyVE4WW'
                            )
                        end
                        for i = 0, 128 do
                            TriggerServerEvent(
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'LUA MENU V2.0 ~ https://discord.gg/qyVE4WW',
                                43161337
                            )
                    ...
                    function()
                        ...
                        for bD = 5, 5 do
                            TriggerServerEvent(
                                ...
                                '^' .. bD .. 'LUA MENU V2.0 ∑ https://discord.gg/qyVE4WWn'
                            )
                        end
                        for i = 0, 128 do
                            local dl =
...
Citizen.CreateThread(
	function()
		...
		MaestroMenu.CreateMenu("MainMenu", "~w~MALOSSIHOSTING V2 ∑")
		MaestroMenu.SetSubTitle("MainMenu", "~w~MALOSSIHOSTING Version 2.0") 
		...
		while Enabled do
			if MaestroMenu.IsMenuOpened("MainMenu") then
			    drawNotification("~w~LUA MENU by ~r~MALOSSIHOSTING ~w~ ~g~") --loooool menu.
				drawNotification("~g~Official Discord: ~r~https://discord.gg/qyVE4WW")
				...
				elseif MaestroMenu.Button("~r~Close Menu") then
					Enabled = false
				elseif MaestroMenu.Button("~w~By ~r~MALOSSIHOSTING ~w~ ~g~" ) then
					Enabled = false
				end
			...
			elseif MaestroMenu.IsMenuOpened("SelfMenu") then
				...
				elseif MaestroMenu.Button("~b~Armour") then
					...
					elseif MaestroMenu.Button("~w~MALOSSIHOSTING swipe ~g~(500k+)") then
				...
				elseif MaestroMenu.Button("~w~MALOSSIHOSTING ~b~VRP ~w~swipe ~g~(500k+)") then
				...
				elseif MaestroMenu.Button("~w~MALOSSIHOSTING ~b~VRP ~w~Salary ~g~(10x)") then
