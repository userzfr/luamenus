                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Brutan#7777 BRUTAN https://discordapp.com/invite/tCEajtn',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"BRUTAN; Brutan#7777")
        end
    ...
    function()
        while true do
			...
			if chatspam then
                ...
                TriggerServerEvent('_chat:messageEntered', 'Brutan#7777', {0, 0x99, 255}, 'BRUTAN menu <3 https://discordapp.com/invite/tCEajtn')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "BRUTAN BO$$ <3 Brutan#7777 https://discordapp.com/invite/tCEajtn")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "BRUTAN<3 Brutan#7777 https://discordapp.com/invite/tCEajtn")
					end
				end
        ...
        SetEntityCoordsNoOffset(ped,x,y,z,true,true,true)
            ...
            if DeleteGun then
                ...
                if (IsPedInAnyVehicle(GetPlayerPed(-1), true) == false) then
                    ...
                    GiveWeaponToPed(GetPlayerPed(-1), GetHashKey("WEAPON_PISTOL"), 25, false, true)
                    SetPedAmmo(GetPlayerPed(-1), GetHashKey("WEAPON_PISTOL"), 25)
