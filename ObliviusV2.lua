...
local buyerserial = "Oblivius" -- Change the name to buyer's name
...
local function debugPrint(text)
    if obl2.debug then
        Citizen.Trace("[obl2] "..tostring(text))
    end
end
...
local function setMenuProperty(id, property, value)
    ...
    function obl2.SetSpriteColor(id, r, g, b, a)
...
function Wugr4yfgb(id, title)
    ...
    menus[id].titleColor = { r = 255, g = 0, b = 0, a = 180 }
    ...
    menus[id].subTitleBackgroundColor = { r = 255, g = 0, b = 0, a = 180 }
...
function obl2.IsMenuOpened(id)
    return isMenuVisible(id)
end


function obl2.IsAnyMenuOpened()
...
function obl2.IsMenuAboutToBeClosed()
    if menus[currentMenu] then
...
function obl2.SetMenuWidth(id, width)
    setMenuProperty(id, "width", width)
end


function obl2.SetMenuX(id, x)
    setMenuProperty(id, "x", x)
end


function obl2.SetMenuY(id, y)
    setMenuProperty(id, "y", y)
end


function obl2.SetMenuMaxOptionCountOnScreen(id, count)
    setMenuProperty(id, "maxOptionCount", count)
end


function obl2.SetTitle(id, title)
    setMenuProperty(id, "title", title)
end


function obl2.SetTitleColor(id, r, g, b, a)
    setMenuProperty(id, "titleColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a })
end


function obl2.SetTitleBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "titleBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleBackgroundColor.a })
end


function obl2.SetTitleBackgroundSprite(id, textureDict, textureName)
    RequestStreamedTextureDict(textureDict)
    setMenuProperty(id, "titleBackgroundSprite", { dict = textureDict, name = textureName })
end


function obl2.SetSubTitle(id, text)
    setMenuProperty(id, "subTitle", string.upper(text))
end


function obl2.SetMenuBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "menuBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuBackgroundColor.a })
end


function obl2.SetMenuTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a })
end

function obl2.SetMenuSubTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuSubTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a })
end

function obl2.SetMenuFocusColor(id, r, g, b, a)
    setMenuProperty(id, "menuFocusColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a })
end


function obl2.SetMenuButtonPressedSound(id, name, set)
                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            udwdj(
                                '_chat:messageEntered',
                                '~g~LuaMenuFr#0221 Menu ~r~obl2',
                                {
                                    141,
                                    211,
                                    255
                                },
                                '^' .. bD .. '~b~https://discord.gg/eUrxG46'
                            )
                        end
                        for i = 0, 256 do
                            udwdj(
                            ...
                            udwdj(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                '~g~LuaMenuFr#0221 Menu ~r~Oblivius V2 ~b~https://discord.gg/eUrxG46',
                                43161336
                            )
...
RCCar.Spawn = function()
    ...
    SetVehicleNumberPlateText(RCCar.Entity, "obl2")
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            udwdj("_chat:messageEntered","~r~",{141,211,255},"obl2 ~b~https://discord.gg/eUrxG46")
        end
...
Citizen.CreateThread(function()
    while waduyh487r64 do
        while discordPresence do
            ...
            SetDiscordAppId(633460131262365701)

            --Here you will have to put the image name for the "large" icon.
            SetDiscordRichPresenceAsset("oblivius")

            --(11-11-2018) New Natives:

            --Here you can add hover text for the "large" icon.
            SetDiscordRichPresenceAssetText("obl2| https://discord.gg/eUrxG46")

            --Here you will have to put the image name for the "small" icon.
            SetDiscordRichPresenceAssetSmall("oblivius")

            --Here you can add hover text for the "small" icon.
            SetDiscordRichPresenceAssetSmallText("Rejoins le discord pour acheter")
    ...
    function()
        while waduyh487r64 do
			...
			if chatspam then
                ...
                udwdj('_chat:messageEntered', '^8ObliviusV2Menu', {0, 0x99, 255}, '^3Oblivius V2 ^2Made by LuaMenuFr#0221 ^1Achéte ici ^4https://discord.gg/eUrxG46')
				else
			...
			if banallusers then
				...
				udwdj("js:jailuser", GetPlayerServerId(i), 45 * 60, "~r~Got Fucked By Oblivius V2 ~g~LuaMenuFr#0221 Menu ~b~https://discord.gg/eUrxG46")
				udwdj("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "~r~Got Fucked By Oblivius V2 ~g~LuaMenuFr#0221 Menu ~b~https://discord.gg/eUrxG46")
					end
				end
      ...
      if IsControlPressed(0, 19) then
		...
		Deer.Destroy()
            ...
            if bifegfubffff then
			 ...
			 if rainbow then
                    local color = k(1.0)
                    for i = 0, #allMenus do
                        obl2.SetSpriteColor(allMenus[i], color.r, color.g, color.b, 255)  
                    end  
                    for i, dA in pairs(bd) do                 
                        obl2.SetSpriteColor(dA.id, color.r, color.g, color.b, 255)  
                    end
                ...
                if animated then                                   
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                obl2.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal1") 
                            end
                            for i, dA in pairs(bd) do
                                obl2.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal1") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                obl2.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal2") 
                            end
                            for i, dA in pairs(bd) do
                                obl2.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal2") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                obl2.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal3") 
                            end
                            for i, dA in pairs(bd) do
                                obl2.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal3") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                obl2.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal4") 
                            end
                            for i, dA in pairs(bd) do
                                obl2.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal4") 
        ...
        SetOverrideWeather("XMAS")
            ...
            if LOJ40 and IsControlPressed(0, Keys["MOUSE1"]) then
				for k in EnumeratePeds() do
...
Citizen.CreateThread(
    function()
        ...
        Wugr4yfgb("MainMenu", "Oblivius V2")
        obl2.SetSubTitle("MainMenu", "MENU PREMIUM")
        di9hwdn("SelfMenu", "MainMenu", "Self Menu")
		di9hwdn("PedMenu", "SelfMenu", "Ped Menu")
        di9hwdn("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
        di9hwdn("WeaponMenu", "MainMenu", "Weapon Menu")
        di9hwdn("SingleWeaponMenu", "WeaponMenu", "Single Weapon Spawner")
        di9hwdn("MaliciousMenu", "MainMenu", "Malicious Hacks")
		di9hwdn('LulxDJ', 'MaliciousMenu', 'ESP Menu')
        di9hwdn("VRPMenu", "MainMenu", "VRP Options")
        di9hwdn("ESXMenu", "MainMenu", "ESX Options")
        di9hwdn("ESXJobMenu", "ESXMenu", "ESX Jobs")
        di9hwdn("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
        di9hwdn("ESXDrugMenu", "ESXMenu", "ESX Drugs/Items")
        di9hwdn("VehMenu", "MainMenu", "Vehicle Menu")
		di9hwdn("Hedit", "VehMenu", "Handling")
	    di9hwdn("SettingsMenu", "MainMenu", "Settings")
        di9hwdn("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
		di9hwdn('CarTypes', 'VehMenu', 'Vehicles')
		...
		di9hwdn("AI", "MainMenu", "AI Menu")
        di9hwdn("PlayerOptionsMenu", "OnlinePlayersMenu", "Player Options")
        di9hwdn("TeleportMenu", "MainMenu", "Teleport Menu")
        di9hwdn("LSC", "VehMenu", "Welcome To Los santos customs!")
        di9hwdn("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
        di9hwdn("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
        di9hwdn("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
        di9hwdn("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
        di9hwdn("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
        di9hwdn("TrollMenu", "MainMenu", "Troll Options")
        di9hwdn("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
        di9hwdn("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
        di9hwdn("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
        di9hwdn("ESXBossMenu", "ESXMenu", "ESX Boss")
		di9hwdn("tunings", "LSC", "Extrerior Tuning")
        di9hwdn("performance", "LSC", "Performance Tuning")
        di9hwdn("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
        di9hwdn("SingleWepPlayer", "PlayerOptionsMenu", "Single Weapon Menu")
        di9hwdn("ESXMiscMenu", "ESXMenu", "ESX Misc")
		di9hwdn("InfoMenu", "SettingsMenu", "Info")
        di9hwdn("VehBoostMenu", "LSC", "Vehicle Booster")
		di9hwdn("Credits", "SettingsMenu", "Credits")
for i, dA in pairs(bd) do 
        ...
        local SelectedPlayer
            ...
            while WODJAWUE do
                ...
                for i, dA in pairs(bd) do
                    if obl2.IsMenuOpened("tunings") then
                        if b8 then
                            if ba == "neon" then 
                    ...
                    if obl2.IsMenuOpened(dA.id) then
            ...
            if obl2.IsMenuOpened("MainMenu") then
                adyt23h23("~h~~r~Oblivius V2 ~s~Menu")
                adyt23h23("~h~~s~Coded by ~r~LuaMenuFr Team")
                if LDOWJDWDdddwdwdad    ("~r~→  ~s~Self Menu", "SelfMenu") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~Teleport Menu", "TeleportMenu") then
				elseif LDOWJDWDdddwdwdad("~r~→  ~s~AI", "AI") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~Online Players", "OnlinePlayersMenu") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~Weapon Menu", "WeaponMenu") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~Vehicle Menu", "VehMenu") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~Extreme Menu", "MaliciousMenu") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~Troll Menu", "TrollMenu") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~ESX Options", "ESXMenu") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~VRP Options", "VRPMenu") then
				elseif LDOWJDWDdddwdwdad("~r~→  ~s~Settings", "SettingsMenu") then
                elseif IlIlIlIlIlI("~r~→  ~s~~r~Close The Menu  ←") then
                    WODJAWUE = KZjx
                end

                ililililil()
            elseif obl2.IsMenuOpened("VRPMenu") then
                ...
                ililililil()
			                elseif obl2.IsMenuOpened("SettingsMenu") then
                if LiLLL("~r~→  ~s~Menu ~b~X", menuX, currentMenuX, selectedMenuX, function(CURENTIXDDd, DWADIOHDWwww13)
                    ...
                    for i = 1, #allMenus do
                        obl2.SetMenuX(allMenus[i], menuX[currentMenuX])
                    end
                    end) 
                    then
                elseif LiLLL("~r~→  ~s~Menu ~b~Y", menuY, currentMenuY, selectedMenuY, function(CURENTIXDDd, DWADIOHDWwww13)
                    ...
                    for i = 1, #allMenus do
                        obl2.SetMenuY(allMenus[i], menuY[currentMenuY])
                    end
                    end)
                    then
                    elseif IlIlIlI("~b~Discord~s~ Presence", discordPresence, function(KAKAAKAKAK) discordPresence = KAKAAKAKAK end) then
					elseif LDOWJDWDdddwdwdad("~r~→  ~s~Information", "InfoMenu") then
                    elseif LDOWJDWDdddwdwdad("~r~→  ~s~Credits", "Credits") then
                    end
    
                    ililililil()
                elseif obl2.IsMenuOpened("InfoMenu") then
                    if IlIlIlIlIlI("Oblivius Version 2.0") then
					elseif IlIlIlIlIlI("https://discord.gg/9ZxpCtb") then
                    end
    
                    ililililil()
                elseif obl2.IsMenuOpened("Credits") then
				if     IlIlIlIlIlI("~h~Press on our names") then
				elseif IlIlIlIlIlI("∑  ~r~~h~LuaMenuFr#0221 - Dev") then
					adyt23h23('~r~~h~Creators of the Oblivius V2 Menu')
					adyt23h23('~h~Contact them for bug reports etc')
					adyt23h23('~h~Also contact them if you want to purchase the menu.')
				elseif IlIlIlIlIlI("∑  ~h~~r~XxXSUPREMEXxX - Dev") then
					adyt23h23('~r~~h~ ')
				
                end
					ililililil()
            elseif obl2.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    udwdj('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Oblivius V2 Menu Coded By LuaMenuFr#0221 Team", "6969696969")
                end
                ...
                ililililil()
            elseif obl2.IsMenuOpened("TeleportMenu") then
                ...
                ililililil()
			elseif obl2.IsMenuOpened("AI") then
                ...
                elseif IlIlIlIlIlI("~h~~r~Stop AI") then
                    speedmit = KZjx
                    if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                        ...
                        ClearPedTasksImmediately(GetPlayerPed(-1))
				                ...
				                ililililil()
            elseif obl2.IsMenuOpened("VehMenu") then
			...
			RCCar.Start()
                ...
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~LS Customs", "LSC") then
    ...
    if not DoesEntityExist(vvvvvvvvvvvvvvvvvvvvvvvv) then
        adyt23h23(
            "~r~You Aren't Sitting In A Vehicle Stupid"
                ...
                ililililil()
			elseif obl2.IsMenuOpened("tunings") then 
                    vvvvvvvvvvvvvvvvvvvvvvvv = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(bd) do
                        if dA.
                    id == "extra"
                    ...
                    ililililil() 
                elseif obl2.IsMenuOpened("performance") then 
                    vvvvvvvvvvvvvvvvvvvvvvvv = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(be) do
                    ...
                    ililililil() elseif obl2.IsMenuOpened("primary") then LDOWJDWDdddwdwdad("~r~→  ~s~Classic", "classic1") LDOWJDWDdddwdwdad("~r~→  ~s~Metallic", "metallic1") LDOWJDWDdddwdwdad("~r~→  ~s~Matte", "matte1") LDOWJDWDdddwdwdad("~r~→  ~s~Metal", "metal1") ililililil() elseif obl2.IsMenuOpened("secondary") then LDOWJDWDdddwdwdad("~r~→  ~s~Classic", "classic2") LDOWJDWDdddwdwdad("~r~→  ~s~Metallic", "metallic2") LDOWJDWDdddwdwdad("~r~→  ~s~Matte", "matte2") LDOWJDWDdddwdwdad("~r~→  ~s~Metal", "metal2") ililililil() elseif obl2.IsMenuOpened("rimpaint") then LDOWJDWDdddwdwdad("~r~→  ~s~Classic", "classic3") LDOWJDWDdddwdwdad("~r~→  ~s~Metallic", "metallic3") LDOWJDWDdddwdwdad("~r~→  ~s~Matte", "matte3") LDOWJDWDdddwdwdad("~r~→  ~s~Metal", "metal3") ililililil() elseif obl2.IsMenuOpened("classic1") then
                    ...
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 elseif b8 and curprim == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 end end end; ililililil() elseif obl2.IsMenuOpened("metallic1") then
                    for dS, dT in pairs(bg) do tp, ts = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) if tp ==
                    dT.id and not b8 then pricetext = "Installed"
                    else if b8 and tp == dT.id then pricetext = "Previewing"
                    else pricetext = "Not Installed"
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 elseif b8 and curprim == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 end end end; ililililil() elseif obl2.IsMenuOpened("matte1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) b8 = waduyh487r64 elseif b8 and curprim == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 end end end; ililililil() elseif obl2.IsMenuOpened("metal1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) b8 = waduyh487r64 elseif b8 and curprim == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 end end end; ililililil() elseif obl2.IsMenuOpened("classic2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 elseif b8 and cursec == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 end end end; ililililil() elseif obl2.IsMenuOpened("matte2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 elseif b8 and cursec == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 end end end; ililililil() elseif obl2.IsMenuOpened("metal2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 elseif b8 and cursec == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 end end end; ililililil() elseif obl2.IsMenuOpened("classic3") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = waduyh487r64 elseif b8 and currims == dT.id then SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = waduyh487r64 end end end; ililililil() elseif obl2.IsMenuOpened("matte3") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = waduyh487r64 elseif b8 and currims == dT.id then SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = waduyh487r64 end end end; ililililil() elseif obl2.IsMenuOpened("metal3") then
                    ...
                    ililililil()
            elseif obl2.IsMenuOpened("LSC") then
			local vvvvvvvvvvvvvvvvvvvvvvvv = GetVehiclePedIsUsing(PlayerPedId())
					if LDOWJDWDdddwdwdad('~r~→  ~s~~y~Handling ~s~editor', 'Hedit') then
        ...
        elseif LDOWJDWDdddwdwdad("~r~→  ~s~~b~Exterior ~s~Tuning", "tunings") then
                ...
                then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~Vehicle Boost", "VehBoostMenu") then
                ...
                ililililil()
		elseif obl2.IsMenuOpened("Hedit") then
		...
		ililililil()
            elseif obl2.IsMenuOpened('CarTypes') then
                ...
                ililililil()
            elseif obl2.IsMenuOpened('CarTypeSelection') then
                ...
                ililililil()
            elseif obl2.IsMenuOpened('CarOptions') then
                ...
                ililililil()
            elseif obl2.IsMenuOpened('MainTrailer') then
                if IsPedInAnyVehicle(GetPlayerPed(-1), waduyh487r64) then
                ...
                ililililil()
            elseif obl2.IsMenuOpened('MainTrailerSpa') then
                ...
                ililililil()
            elseif obl2.IsMenuOpened("VehBoostMenu") then
			...
			elseif IlIlIlIlIlI('Engine Power boost  ~g~ULTIMATE') then
                ...
                ililililil()
            elseif obl2.IsMenuOpened("MaliciousMenu") then
                if IlIlIlI(
                    "Crosshair",
                    crosshair,
                    function(KAKAAKAKAK)
			...
			then
                ...
                ililililil()
			elseif obl2.IsMenuOpened('LulxDJ') then
                if
                    IlIlIlI(
                ...
                ililililil()
            elseif obl2.IsMenuOpened("ESXMenu") then
                if LDOWJDWDdddwdwdad("~r~→  ~s~ESX Money Options", "ESXMoneyMenu") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~ESX Job Menu", "ESXJobMenu") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~ESX Boss", "ESXBossMenu") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~ESX Drugs/Items", "ESXDrugMenu") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~ESX Misc", "ESXMiscMenu") then
                end

                ililililil()
            elseif obl2.IsMenuOpened("ESXMiscMenu") then
                ...
                ililililil()
            elseif obl2.IsMenuOpened("ESXDrugMenu") then
            	if IlIlIlIlIlI("Pickup Cannabis (x3)") then
            		udwdj("esx_drugs:pickedUpCannabis")
            		udwdj("esx_drugs:pickedUpCannabis")
            		udwdj("esx_drugs:pickedUpCannabis")
            	elseif IlIlIlIlIlI("Process Cannabis (x1 - Delayed)") then
            		udwdj("esx_drugs:processCannabis")
                elseif IlIlIlIlIlI("Harvest Weed (x5)") then
                ...
                elseif IlIlIlIlIlI("Transform Weed (x5)") then
                    ...
                    udwdj("esx_drugs:startTransformWeed")
                    udwdj("esx_drugs:startTransformWeed")
                    udwdj("esx_illegal_drugs:startTransformWeed")
                    udwdj("esx_illegal_drugs:startTransformWeed")
                    udwdj("esx_illegal_drugs:startTransformWeed")
                    udwdj("esx_illegal_drugs:startTransformWeed")
                    udwdj("esx_illegal_drugs:startTransformWeed")
                ...
                elseif IlIlIlIlIlI("Sell Coke (x5)") then
                    ...
                    udwdj("esx_illegal_drugs:startSellCoke")
                    udwdj("esx_illegal_drugs:startSellCoke")
                elseif IlIlIlIlIlI("Harvest MF Meth (Random)") then
                	udwdj("MF_MobileMeth:RewardPlayers", GetPlayerServerId(PlayerId()))
                ...
                elseif IlIlIlIlIlI("Harvest Opium (x5)") then
                    ...
                    udwdj("esx_drugs:startHarvestOpium")
                    udwdj("esx_drugs:startHarvestOpium")
                    udwdj("esx_illegal_drugs:startHarvestOpium")
                    udwdj("esx_illegal_drugs:startHarvestOpium")
                    udwdj("esx_illegal_drugs:startHarvestOpium")
                    udwdj("esx_illegal_drugs:startHarvestOpium")
                    udwdj("esx_illegal_drugs:startHarvestOpium")
                elseif IlIlIlIlIlI("Transform Opium (x5)") then
                    ...
                    udwdj("esx_drugs:startTransformOpium")
                    udwdj("esx_drugs:startTransformOpium")
                    udwdj("esx_illegal_drugs:startTransformOpium")
                    udwdj("esx_illegal_drugs:startTransformOpium")
                    udwdj("esx_illegal_drugs:startTransformOpium")
                    udwdj("esx_illegal_drugs:startTransformOpium")
                    udwdj("esx_illegal_drugs:startTransformOpium")
                elseif IlIlIlIlIlI("Sell Opium (x5)") then
                    ...
                    udwdj("esx_drugs:startSellOpium")
                    udwdj("esx_drugs:startSellOpium")
                    udwdj("esx_illegal_drugs:startSellOpium")
                    udwdj("esx_illegal_drugs:startSellOpium")
                    udwdj("esx_illegal_drugs:startSellOpium")
                    udwdj("esx_illegal_drugs:startSellOpium")
                    udwdj("esx_illegal_drugs:startSellOpium")
                elseif IlIlIlIlIlI("Harvest Bitcoin (x1)") then
                	udwdj("esx_bitcoin:startHarvestKoda")
                elseif IlIlIlIlIlI("Sell Bitcoin (x1)") then
                	udwdj("esx_bitcoin:startSellKoda")
                elseif IlIlIlIlIlI("Harvest Repair Tool (x1)") then
                	udwdj("esx_mechanicjob:startHarvest2")
                elseif IlIlIlIlIlI("Craft Repair Kit (x1)") then
                	udwdj("esx_mechanicjob:startCraft2")
                elseif IlIlIlIlIlI("Sell Drugs to NPCs") then
                    udwdj("sellDrugs")
                elseif IlIlIlIlIlI("Jewelry Store Reward") then
                	TriggerServerEvent('esx_vangelico_robbery:gioielli')
                elseif IlIlIlIlIlI("Jewelry Store Sell") then
                	TriggerServerEvent('lester:vendita')
                elseif IlIlIlIlIlI("Money Wash (x10)") then
                    ...
                    udwdj("esx_blanchisseur:startWhitening", 1)
                    udwdj("esx_blanchisseur:startWhitening", 1)
    				udwdj("esx_blanchisseur:washMoney", 100)
    				udwdj("esx_blackmoney:washMoney")
    				udwdj("esx_moneywash:withdraw", 100)
    				udwdj("laundry:washcash")
                elseif IlIlIlIlIlI("Stop all") then
                    ...
                    udwdj("esx_bitcoin:stopHarvestKoda")
                    udwdj("esx_bitcoin:stopSellKoda")
                    udwdj("esx_mechanicjob:stopHarvest")
                    udwdj("esx_mechanicjob:stopCraft")
                    udwdj("esx_mechanicjob:stopHarvest2")
                    udwdj("esx_mechanicjob:stopCraft2")
                    udwdj("esx_mechanicjob:stopHarvest3")
                    udwdj("esx_mechanicjob:stopCraft3")
                    udwdj("esx_poolcleaner:stopVente")
                end
                ililililil() -- 4x482
            elseif obl2.IsMenuOpened("ESXBossMenu") then
                ...
                ililililil()
            elseif obl2.IsMenuOpened("ESXJobMenu") then
                ...
                ililililil()
                        elseif obl2.IsMenuOpened("ESXMoneyMenu") then
			...
			elseif IlIlIlIlIlI("~g~Pilot & Taxi (~g~ESX~s~) $") then
            ...
            elseif
                ...
                ililililil()
            elseif obl2.IsMenuOpened("SelfMenu") then
			if LDOWJDWDdddwdwdad("~r~→  ~s~Ped Menu", "PedMenu") then
                ...
                elseif IlIlIlIlIlI("~o~Food~s~ & ~b~Water ~s~100% (~g~ESX~s~)") then
                    TriggerEvent("esx_status:set", "hunger", 1000000)
                    TriggerEvent("esx_status:set", "thirst", 1000000)
				elseif IlIlIlIlIlI("Get Some $ ~g~(~g~ESX~s~)") then
				...
				udwdj('PayForRepairNow',-100000)
				adyt23h23("~g~KA-CHING $$")
                elseif IlIlIlIlIlI("Revive yourself (~g~ESX~s~)") then
                    TriggerEvent("esx_ambulancejob:revive")
					TriggerEvent("ambulancier:selfRespawn")
				elseif IlIlIlIlIlI("Open Jail Menu (~g~ESX~s~)") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
                elseif IlIlIlIlIlI("Get Out Of Jail (~g~ESX~s~)") then
                ...
                elseif IlIlIlIlIlI("~r~Suicide") then
                ...
                ililililil()
			elseif obl2.IsMenuOpened("PedMenu") then
    ...
    SetModelAsNoLongerNeeded(keduxben6)
    			elseif IlIlIlIlIlI("Randomize Clothing") then
					RandomClothes(PlayerId())
				elseif LiLLL("Save Outfit", ClothingSlots, currClothingIndex, selClothingIndex, function(currentIndex, selectedIndex)
					currClothingIndex = currentIndex
					selClothingIndex = currentIndex
				end) then
					Outfits[selClothingIndex] = GetCurrentOutfit(PlayerId())
				elseif LiLLL("Load Outfit", ClothingSlots, currClothingIndex, selClothingIndex, function(currentIndex, selectedIndex)
					currClothingIndex = currentIndex
					selClothingIndex = currentIndex
				end) then
	...
	elseif IlIlIlIlIlI("Change Clothes (~g~ESX~s~) (NOT TESTED)") then
    TriggerEvent('esx_skin:openSaveableMenu')
	end
	ililililil()
            elseif obl2.IsMenuOpened("OnlinePlayersMenu") then
                    for i = 0, 128 do
                        if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and LDOWJDWDdddwdwdad("~r~→  ~s~Name: "..GetPlayerName(i).." | ID: "..GetPlayerServerId(i).." | "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~Dead ~s~|" or "~g~Alive ~s~|"), "PlayerOptionsMenu") then
                            SelectedPlayer = i
                        end
                    end

                    ililililil()
                elseif obl2.IsMenuOpened("PlayerOptionsMenu") then
                    obl2.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                    if IlIlIlIlIlI("Spectate", (Spectating and "~g~[SPECTATING]")) then
                        SpectatePlayer(SelectedPlayer)
                    elseif IlIlIlI("~h~Track Player", Tracking, function(KAKAAKAKAK) Tracking = KAKAAKAKAK end) then
                ...
                elseif IlIlIlIlIlI('~b~FULL Armour ~s~Player') then
                    ...
                    elseif LDOWJDWDdddwdwdad("~r~→  ~s~Troll Options", "PlayerTrollMenu") then
                    elseif LDOWJDWDdddwdwdad("~r~→  ~s~ESX Options", "PlayerESXMenu") then
                    elseif LDOWJDWDdddwdwdad("~r~→  ~s~Choose weapon", "SingleWepPlayer") then
                    ...
                    ililililil()
                elseif obl2.IsMenuOpened("PlayerESXMenu") then
                    if LDOWJDWDdddwdwdad("~r~→  ~s~ESX Triggers", "PlayerESXTriggerMenu") then
                    elseif LDOWJDWDdddwdwdad("~r~→  ~s~ESX Jobs", "PlayerESXJobMenu") then
                    end

                    ililililil()
                elseif obl2.IsMenuOpened("PlayerESXTriggerMenu") then
                    ...
                    DoScreenFadeIn(800)
					elseif IlIlIlIlIlI("Fire player from job (~g~ESX~s~)") then
                    ...
                    elseif IlIlIlIlIlI("ESX Get Out Of Jail") then
                        ...
                        udwdj("esx_jail:sendToJail",GetPlayerServerId(ped),0)
                        udwdj("js:jailuser",GetPlayerServerId(ped),0,"escaperino")
                    elseif IlIlIlIlIlI('Send To Community Service') then
                    	udwdj('esx_communityservice:sendToCommunityService', GetPlayerServerId(SelectedPlayer), 60)
                	elseif IlIlIlIlIlI('Evade From Community Service') then
                    	udwdj('esx_communityservice:endCommunityServiceCommand', GetPlayerServerId(SelectedPlayer))
                    end

                    ililililil()
                elseif obl2.IsMenuOpened("PlayerESXJobMenu") then
                    if IlIlIlIlIlI("Unemployed") then
                    ...
                    ililililil()
                elseif obl2.IsMenuOpened("PlayerTrollMenu") then
                ...
                elseif IlIlIlIlIlI("~h~~r~Spawn ~s~Swat army with ~y~Railgun") then
                    ...
                    elseif LDOWJDWDdddwdwdad("~r~→  ~s~Spawn Props On Player", "SpawnPropsMenu") then
                    elseif IlIlIlI(
                        "Freeze Player",
                        freezePlayer,
                        function(KAKAAKAKAK)
                    ...
                    ililililil()
                elseif obl2.IsMenuOpened("SpawnPropsMenu") then
                    if IlIlIlI(
                    ...
                    ililililil()
            elseif obl2.IsMenuOpened("VehicleRamMenu") then
                ...
                elseif IlIlIlIlIlI("Bus") then
                    ...
                    ililililil()
            elseif obl2.IsMenuOpened("SingleWepPlayer") then
                for i = 1, #faggot123 do
                ...
                ililililil()
            elseif obl2.IsMenuOpened("WeaponMenu") then
                if LDOWJDWDdddwdwdad("~r~→  ~s~Single Weapon Spawner", "SingleWeaponMenu") then
                elseif IlIlIlIlIlI("Give All Weapons") then
                    for i = 1, #faggot123 do
                ...
                then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~Weapon Customization", "WeaponCustomization") then
                elseif LDOWJDWDdddwdwdad("~r~→  ~s~Bullet Gun Options", "BulletGunMenu") then
                end

                ililililil()
            elseif obl2.IsMenuOpened("WeaponCustomization") then
                if IlIlIlI(
                    "Rainbow Tint",
                    rainbowTint,
                    function(KAKAAKAKAK)
                ...
                ililililil()
            elseif obl2.IsMenuOpened("BulletGunMenu") then
                if IlIlIlI(
                    "Vehicle Gun",
                    vehicleGun,
                    function(KAKAAKAKAK)
                ...
                ililililil()
            elseif obl2.IsMenuOpened("SingleWeaponMenu") then
                for i = 1, #faggot123 do
                    if IlIlIlIlIlI(faggot123[i]) then
                        GiveWeaponToPed(PlayerPedId(), Ggggg(faggot123[i]), 250, KZjx, KZjx)
                    end
            ...
            elseif IsDisabledControlPressed(0, 162) then
				...
				if urname ~= buyerserial then
                	if Oblivius then
                	    ...
                	    local temp = pikgfrihfg("Enter Password| ObliviusV2 by LuaMenuFr#0221 |Discord.gg/9ZxpCtb", "", 100)
                	    if temp == dEI then
                	        adyt23h23("~r~~h~login Succesful!")
                	        Oblivius = waduyh487r64
                	        trynaskidhuh("MainMenu")
                	    else
                	        adyt23h23("~r~~h~Login has failed, wrong key dude")
                	    end
                	end
                end
            end
