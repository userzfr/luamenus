		...
		while Enabled do
			...
			if blowall then
                for i = 0, 64 do
						...
						TriggerServerEvent('_chat:messageEntered', "Vyorex Community", { 141, 211, 255 }, "/ooc Lynx 8 Vyorex ~ https://discord.gg/7bM3z5P")
                end
			end
			...
			if nuke then
                ...
                for i = 0, 64 do
						...
						TriggerServerEvent('_chat:messageEntered', "Vyorex Community", { 141, 211, 255 }, "/ooc Lynx 8 Vyorex ~ https://discord.gg/7bM3z5P")
						TriggerServerEvent('_chat:messageEntered', "Vyorex Community", { 141, 211, 255 }, "Lynx 8 Vyorex ~ https://discord.gg/7bM3z5P")
                end
			end
	...
	function()
		...
		while Enabled do
			if Lynx8.IsMenuOpened("Lynx8") then
				...
				drawNotification("<FONT COLOR='#22ff40'>https://discord.gg/7bM3z5P")
...
elseif Lynx8.IsMenuOpened("Credits") then
	...
	elseif Lynx8.Button("~h~~p~->~s~ https://discord.gg/7bM3z5P~r~ ~r~= ~p~(~o~DISCORD~p~)") then
end
