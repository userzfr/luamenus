...
--decrypted by xseira fucking gay shit
    ...
    Citizen.CreateThread(
        function()
            ...
            xseira.CreateMenu("MainMenu", "xaries gang 2")
	  ...
	  local function ss()
		   for i = 0, 256 do
			if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 then
				print("xD")
				TriggerServerEvent('esx_policejob:message',  GetPlayerServerId(i), '~r~https://xaries.pl ~w~\n~b~Yo many ~w~\n ~f~xaries gang menu v2 \n')
				TriggerServerEvent("tablet_lscm:SendMessage", GetPlayerServerId(i), math.random(999999,99999999),  '~r~https://xaries.pl ~w~\n~b~Yo many ~w~\n ~f~xaries gang menu v2 \n')
				TriggerServerEvent("searp:SendMessage", GetPlayerServerId(i), -34234234234234234324332, "xaries gang menu v2")
				TriggerServerEvent("wyspa_jail:SendMessagea", GetPlayerServerId(i), -34234234234234234324332, "xaries gang menu v2")
				TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), -34234234234234234324332, "xaries gang menu v2")
			end
		end
	end
